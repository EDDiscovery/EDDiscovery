...
namespace EDDiscovery.UserControls.Colonisation
{
    public class ColonisationData
    {
        ...
        public Ret Add(HistoryEntry he, List<HistoryEntry> hl, bool debug = false)
        {
            ...
            {
                //var classify = StationDefinitions.Classify(cd.MarketID, StationDefinitions.StarportTypes.Unknown); global::System.Diagnostics.Debug.WriteLine($"{he.EventTimeUTC} {cd.MarketID} {classify} Colonisation depot `{he.Status.StationName_Localised}` {he.Status.StationType} {cd.ConstructionProgress * 100.0:N2} @ {he.System.Name} ");
