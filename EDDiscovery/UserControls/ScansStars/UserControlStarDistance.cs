...
namespace EDDiscovery.UserControls
{
    public partial class UserControlStarDistance : UserControlCommonBase
    {
        ...
        public override void Init()
        {
            ...
            textMinRadius.ValueNoChange = UserDatabase.Instance.GetSettingDouble(DbSave + "Min", defaultMinRadius);
            textMaxRadius.ValueNoChange = UserDatabase.Instance.GetSettingDouble(DbSave + "Max", defaultMaxRadius);
            ...
            checkBoxCube.Checked = UserDatabase.Instance.GetSettingBool(DbSave + "Behaviour", false);
        ...
        public override void Closing()
        {
            ...
            uctg.OnTravelSelectionChanged -= Uctg_OnTravelSelectionChanged;
            computer.ShutDown();
            UserDatabase.Instance.PutSettingDouble(DbSave + "Min", textMinRadius.Value);
            UserDatabase.Instance.PutSettingDouble(DbSave + "Max", textMaxRadius.Value);
            UserDatabase.Instance.PutSettingBool(DbSave + "Behaviour", checkBoxCube.Checked);
        }
