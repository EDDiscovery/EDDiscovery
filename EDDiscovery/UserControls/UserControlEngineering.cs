            ...
            if (last_he != null)
            {
                ...
                for (int i = 0; i < Recipes.Count; i++)
                {
                    ...
                    else
                    {
                        ...
                        {
                            visible = visible && upgrades.Split(';').Contains(Recipes[rno].name);
                        }
                    }
...
//                    System.Diagnostics.Debug.WriteLine("move: Drag Start");
        ...
        List<MaterialCommoditiesList.EngineeringRecipe> Recipes = new List<MaterialCommoditiesList.EngineeringRecipe>()
        {
            ...
            new MaterialCommoditiesList.EngineeringRecipe("Efficient Weapon", "1S", "Beam Laser", 1, "Broo Tarquin"),
            new MaterialCommoditiesList.EngineeringRecipe("Efficient Weapon", "1HDP,1S", "Beam Laser", 2, "Broo Tarquin"),
            new MaterialCommoditiesList.EngineeringRecipe("Efficient Weapon", "1Cr,1ESED,1HE", "Beam Laser", 3, "Broo Tarquin"),
            ...
            new MaterialCommoditiesList.EngineeringRecipe("Overcharged", "1Ni", "Beam Laser", 1, "Broo Tarquin"),
            new MaterialCommoditiesList.EngineeringRecipe("Overcharged", "1CCo,1Ni", "Beam Laser", 2, "Broo Tarquin"),
            new MaterialCommoditiesList.EngineeringRecipe("Overcharged", "1CCo,1EA,1Ni", "Beam Laser", 3, "Broo Tarquin"),
            ...
            new MaterialCommoditiesList.EngineeringRecipe("Efficient Weapon", "1Cr,1ESED,1HE", "Burst Laser", 3, "Broo Tarquin"),
            ...
            new MaterialCommoditiesList.EngineeringRecipe("Focused", "1Cr,1CCo,1Fe", "Burst Laser", 3, "Broo Tarquin,The Dweller"),
            ...
            new MaterialCommoditiesList.EngineeringRecipe("Light Weight", "1CCe,1Mn,1SAll", "Burst Laser", 3, "Broo Tarquin"),
            ...
            new MaterialCommoditiesList.EngineeringRecipe("Long Range", "1FoC,1MCF,1S", "Burst Laser", 3, "Broo Tarquin"),
            ...
            new MaterialCommoditiesList.EngineeringRecipe("Overcharged", "1CCo,1EA,1Ni", "Burst Laser", 3, "Broo Tarquin"),
            ...
            new MaterialCommoditiesList.EngineeringRecipe("Short Range Blaster", "1EA,1MCF,1Ni", "Burst Laser", 3, "Broo Tarquin"),
            ...
            new MaterialCommoditiesList.EngineeringRecipe("Sturdy Mount", "1Ni,1SE,1W", "Burst Laser", 3, "Broo Tarquin"),
            ...
            new MaterialCommoditiesList.EngineeringRecipe("Light Weight", "1Mo", "Cannon", 1, "Tod \"The Blaster\" McQuinn,The Sarge"),
            ...
            new MaterialCommoditiesList.EngineeringRecipe("Light Weight", "1P", "Collector Limpet Controller", 1, "Tania Fortune,The Sarge,Ram Tah"),
            new MaterialCommoditiesList.EngineeringRecipe("Light Weight", "1Mn,1SAll", "Collector Limpet Controller", 2, "Tania Fortune,The Sarge,Ram Tah"),
            new MaterialCommoditiesList.EngineeringRecipe("Light Weight", "1CCe,1Mn,1SAll", "Collector Limpet Controller", 3, "Tania Fortune,The Sarge,Ram Tah"),
            new MaterialCommoditiesList.EngineeringRecipe("Light Weight", "1CCo,1PA,1PLA", "Collector Limpet Controller", 4, "Tania Fortune,The Sarge,Ram Tah"),
            new MaterialCommoditiesList.EngineeringRecipe("Light Weight", "1CCe,1PLA,1PRA", "Collector Limpet Controller", 5, "Tania Fortune,The Sarge,Ram Tah"),
            new MaterialCommoditiesList.EngineeringRecipe("Reinforced", "1Ni", "Collector Limpet Controller", 1, "Tania Fortune,The Sarge,Ram Tah"),
            new MaterialCommoditiesList.EngineeringRecipe("Reinforced", "1Ni,1SE", "Collector Limpet Controller", 2, "Tania Fortune,The Sarge,Ram Tah"),
            new MaterialCommoditiesList.EngineeringRecipe("Reinforced", "1Ni,1SE,1W", "Collector Limpet Controller", 3, "Tania Fortune,The Sarge,Ram Tah"),
            new MaterialCommoditiesList.EngineeringRecipe("Reinforced", "1Mo,1W,1Zn", "Collector Limpet Controller", 4, "Tania Fortune,The Sarge,Ram Tah"),
            new MaterialCommoditiesList.EngineeringRecipe("Reinforced", "1HDC,1Mo,1Tc", "Collector Limpet Controller", 5, "Tania Fortune,The Sarge,Ram Tah"),
            new MaterialCommoditiesList.EngineeringRecipe("Shielded", "1WSE", "Collector Limpet Controller", 1, "Tania Fortune,The Sarge,Ram Tah"),
            new MaterialCommoditiesList.EngineeringRecipe("Shielded", "1C,1SE", "Collector Limpet Controller", 2, "Tania Fortune,The Sarge,Ram Tah"),
            new MaterialCommoditiesList.EngineeringRecipe("Shielded", "1C,1HDC", "Collector Limpet Controller", 3, "Tania Fortune,The Sarge,Ram Tah"),
            new MaterialCommoditiesList.EngineeringRecipe("Shielded", "1PCo,1SS,1V", "Collector Limpet Controller", 4, "Tania Fortune,The Sarge,Ram Tah"),
            new MaterialCommoditiesList.EngineeringRecipe("Shielded", "1CoS,1CDC,1W", "Collector Limpet Controller", 5, "Tania Fortune,The Sarge,Ram Tah"),
            new MaterialCommoditiesList.EngineeringRecipe("Fast Scan", "1P", "Detailed Surface Scanner", 1, "Juri Ishmaak,Lei Cheung,Lori Jameson,Tania Fortune,Bill Turner"),
            new MaterialCommoditiesList.EngineeringRecipe("Fast Scan", "1FFC,1P", "Detailed Surface Scanner", 2, "Juri Ishmaak,Lei Cheung,Lori Jameson,Tania Fortune,Bill Turner"),
            new MaterialCommoditiesList.EngineeringRecipe("Fast Scan", "1FFC,1OSK,1P", "Detailed Surface Scanner", 3, "Lori Jameson,Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Fast Scan", "1AEA,1FoC,1Mn", "Detailed Surface Scanner", 4, "Lori Jameson,Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Fast Scan", "1AEC,1As,1RFC", "Detailed Surface Scanner", 5, "Lori Jameson,Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Long Range", "1Fe", "Detailed Surface Scanner", 1, "Juri Ishmaak,Lei Cheung,Lori Jameson,Tania Fortune,Bill Turner"),
            new MaterialCommoditiesList.EngineeringRecipe("Long Range", "1HC,1Fe", "Detailed Surface Scanner", 2, "Juri Ishmaak,Lei Cheung,Lori Jameson,Tania Fortune,Bill Turner"),
            new MaterialCommoditiesList.EngineeringRecipe("Long Range", "1HC,1Fe,1UED", "Detailed Surface Scanner", 3, "Lori Jameson,Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Long Range", "1DED,1EA,1Ge", "Detailed Surface Scanner", 4, "Lori Jameson,Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Long Range", "1ACED,1Nb,1PCa", "Detailed Surface Scanner", 5, "Lori Jameson,Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Wide Angle", "1MS", "Detailed Surface Scanner", 1, "Juri Ishmaak,Lei Cheung,Lori Jameson,Tania Fortune,Bill Turner"),
            new MaterialCommoditiesList.EngineeringRecipe("Wide Angle", "1Ge,1MS", "Detailed Surface Scanner", 2, "Juri Ishmaak,Lei Cheung,Lori Jameson,Tania Fortune,Bill Turner"),
            new MaterialCommoditiesList.EngineeringRecipe("Wide Angle", "1CSD,1Ge,1MS", "Detailed Surface Scanner", 3, "Lori Jameson,Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Wide Angle", "1DSD,1ME,1Nb", "Detailed Surface Scanner", 4, "Lori Jameson,Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Wide Angle", "1CSD,1ME,1Sn", "Detailed Surface Scanner", 5, "Lori Jameson,Tania Fortune"),
            ...
            new MaterialCommoditiesList.EngineeringRecipe("Expanded Capture Arc", "1MS", "Frame Shift Drive Interdictor", 1, "Colonel Bris Dekker,Felicity Farseer,Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Expanded Capture Arc", "1ME,1UEF", "Frame Shift Drive Interdictor", 2, "Colonel Bris Dekker,Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Expanded Capture Arc", "1GR,1MC,1TEC", "Frame Shift Drive Interdictor", 3, "Colonel Bris Dekker,Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Expanded Capture Arc", "1DSD,1ME,1SWS", "Frame Shift Drive Interdictor", 4, "Colonel Bris Dekker,Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Expanded Capture Arc", "1CSD,1EHT,1MC", "Frame Shift Drive Interdictor", 5, "Colonel Bris Dekker,Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Longer Range", "1UEF", "Frame Shift Drive Interdictor", 1, "Colonel Bris Dekker,Felicity Farseer,Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Longer Range", "1ADWE,1TEC", "Frame Shift Drive Interdictor", 2, "Colonel Bris Dekker,Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Longer Range", "1ABSD,1AFT,1OSK", "Frame Shift Drive Interdictor", 3, "Colonel Bris Dekker,Tania Fortune"),
            ...
            new MaterialCommoditiesList.EngineeringRecipe("Light Weight", "1P", "Fuel Transfer Limpet Controller", 1, "Tania Fortune,The Sarge,Ram Tah"),
            new MaterialCommoditiesList.EngineeringRecipe("Light Weight", "1Mn,1SAll", "Fuel Transfer Limpet Controller", 2, "Tania Fortune,The Sarge,Ram Tah"),
            new MaterialCommoditiesList.EngineeringRecipe("Light Weight", "1CCe,1Mn,1SAll", "Fuel Transfer Limpet Controller", 3, "Tania Fortune,The Sarge,Ram Tah"),
            new MaterialCommoditiesList.EngineeringRecipe("Light Weight", "1CCo,1PA,1PLA", "Fuel Transfer Limpet Controller", 4, "Tania Fortune,The Sarge,Ram Tah"),
            new MaterialCommoditiesList.EngineeringRecipe("Light Weight", "1CCe,1PLA,1PRA", "Fuel Transfer Limpet Controller", 5, "Tania Fortune,The Sarge,Ram Tah"),
            new MaterialCommoditiesList.EngineeringRecipe("Reinforced", "1Ni", "Fuel Transfer Limpet Controller", 1, "Tania Fortune,The Sarge,Ram Tah"),
            new MaterialCommoditiesList.EngineeringRecipe("Reinforced", "1Ni,1SE", "Fuel Transfer Limpet Controller", 2, "Tania Fortune,The Sarge,Ram Tah"),
            new MaterialCommoditiesList.EngineeringRecipe("Reinforced", "1Ni,1SE,1W", "Fuel Transfer Limpet Controller", 3, "Tania Fortune,The Sarge,Ram Tah"),
            new MaterialCommoditiesList.EngineeringRecipe("Reinforced", "1Mo,1W,1Zn", "Fuel Transfer Limpet Controller", 4, "Tania Fortune,The Sarge,Ram Tah"),
            new MaterialCommoditiesList.EngineeringRecipe("Reinforced", "1HDC,1Mo,1Tc", "Fuel Transfer Limpet Controller", 5, "Tania Fortune,The Sarge,Ram Tah"),
            new MaterialCommoditiesList.EngineeringRecipe("Shielded", "1WSE", "Fuel Transfer Limpet Controller", 1, "Tania Fortune,The Sarge"),
            new MaterialCommoditiesList.EngineeringRecipe("Shielded", "1C,1SE", "Fuel Transfer Limpet Controller", 2, "Tania Fortune,The Sarge"),
            new MaterialCommoditiesList.EngineeringRecipe("Shielded", "1C,1HDC", "Fuel Transfer Limpet Controller", 3, "Tania Fortune,The Sarge"),
            new MaterialCommoditiesList.EngineeringRecipe("Shielded", "1PCo,1SS,1V", "Fuel Transfer Limpet Controller", 4, "Tania Fortune,The Sarge"),
            new MaterialCommoditiesList.EngineeringRecipe("Shielded", "1CoS,1CDC,1W", "Fuel Transfer Limpet Controller", 5, "Tania Fortune,The Sarge"),
            new MaterialCommoditiesList.EngineeringRecipe("Light Weight", "1P", "Hatch Breaker Limpet Controller", 1, "Tania Fortune,The Sarge,Ram Tah"),
            new MaterialCommoditiesList.EngineeringRecipe("Light Weight", "1Mn,1SAll", "Hatch Breaker Limpet Controller", 2, "Tania Fortune,The Sarge,Ram Tah"),
            new MaterialCommoditiesList.EngineeringRecipe("Light Weight", "1CCe,1Mn,1SAll", "Hatch Breaker Limpet Controller", 3, "Tania Fortune,The Sarge,Ram Tah"),
            new MaterialCommoditiesList.EngineeringRecipe("Light Weight", "1CCo,1PA,1PLA", "Hatch Breaker Limpet Controller", 4, "Tania Fortune,The Sarge,Ram Tah"),
            new MaterialCommoditiesList.EngineeringRecipe("Light Weight", "1CCe,1PLA,1PRA", "Hatch Breaker Limpet Controller", 5, "Tania Fortune,The Sarge,Ram Tah"),
            new MaterialCommoditiesList.EngineeringRecipe("Reinforced", "1Ni", "Hatch Breaker Limpet Controller", 1, "Tania Fortune,The Sarge,Ram Tah"),
            new MaterialCommoditiesList.EngineeringRecipe("Reinforced", "1Ni,1SE", "Hatch Breaker Limpet Controller", 2, "Tania Fortune,The Sarge,Ram Tah"),
            new MaterialCommoditiesList.EngineeringRecipe("Reinforced", "1Ni,1SE,1W", "Hatch Breaker Limpet Controller", 3, "Tania Fortune,The Sarge,Ram Tah"),
            new MaterialCommoditiesList.EngineeringRecipe("Reinforced", "1Mo,1W,1Zn", "Hatch Breaker Limpet Controller", 4, "Tania Fortune,The Sarge"),
            new MaterialCommoditiesList.EngineeringRecipe("Reinforced", "1HDC,1Mo,1Tc", "Hatch Breaker Limpet Controller", 5, "Tania Fortune,The Sarge"),
            new MaterialCommoditiesList.EngineeringRecipe("Shielded", "1WSE", "Hatch Breaker Limpet Controller", 1, "Tania Fortune,The Sarge,Ram Tah"),
            new MaterialCommoditiesList.EngineeringRecipe("Shielded", "1C,1SE", "Hatch Breaker Limpet Controller", 2, "Tania Fortune,The Sarge,Ram Tah"),
            new MaterialCommoditiesList.EngineeringRecipe("Shielded", "1C,1HDC", "Hatch Breaker Limpet Controller", 3, "Tania Fortune,The Sarge,Ram Tah"),
            new MaterialCommoditiesList.EngineeringRecipe("Shielded", "1PCo,1SS,1V", "Hatch Breaker Limpet Controller", 4, "Tania Fortune,The Sarge"),
            new MaterialCommoditiesList.EngineeringRecipe("Shielded", "1CoS,1CDC,1W", "Hatch Breaker Limpet Controller", 5, "Tania Fortune,The Sarge"),
            ...
            new MaterialCommoditiesList.EngineeringRecipe("Light Weight", "1CCo,1Fe", "Hull Reinforcement Package", 2, "Liz Ryder,Selene Jean"),
            new MaterialCommoditiesList.EngineeringRecipe("Light Weight", "1CCo,1HDC,1Fe", "Hull Reinforcement Package", 3, "Liz Ryder,Selene Jean"),
            new MaterialCommoditiesList.EngineeringRecipe("Light Weight", "1CCe,1Ge,1PCo", "Hull Reinforcement Package", 4, "Liz Ryder,Selene Jean"),
            new MaterialCommoditiesList.EngineeringRecipe("Light Weight", "1CCe,1MGA,1Sn", "Hull Reinforcement Package", 5, "Liz Ryder,Selene Jean"),
            ...
            new MaterialCommoditiesList.EngineeringRecipe("Fast Scan", "1P", "Kill Warrant Scanner", 1, "Juri Ishmaak,Lori Jameson,Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Fast Scan", "1FFC,1P", "Kill Warrant Scanner", 2, "Juri Ishmaak,Lori Jameson,Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Fast Scan", "1FFC,1OSK,1P", "Kill Warrant Scanner", 3, "Juri Ishmaak,Lori Jameson,Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Fast Scan", "1AEA,1FoC,1Mn", "Kill Warrant Scanner", 4, "Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Fast Scan", "1AEC,1As,1RFC", "Kill Warrant Scanner", 5, "Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Light Weight", "1P", "Kill Warrant Scanner", 1, "Juri Ishmaak,Lori Jameson,Tania Fortune,Bill Turner"),
            new MaterialCommoditiesList.EngineeringRecipe("Light Weight", "1Mn,1SAll", "Kill Warrant Scanner", 2, "Juri Ishmaak,Lori Jameson,Tania Fortune,Bill Turner"),
            new MaterialCommoditiesList.EngineeringRecipe("Light Weight", "1CCe,1Mn,1SAll", "Kill Warrant Scanner", 3, "Juri Ishmaak,Lori Jameson,Tania Fortune,Bill Turner"),
            new MaterialCommoditiesList.EngineeringRecipe("Light Weight", "1CCo,1PA,1PLA", "Kill Warrant Scanner", 4, "Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Light Weight", "1CCe,1PLA,1PRA", "Kill Warrant Scanner", 5, "Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Long Range", "1Fe", "Kill Warrant Scanner", 1, "Juri Ishmaak,Lori Jameson,Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Long Range", "1HC,1Fe", "Kill Warrant Scanner", 2, "Juri Ishmaak,Lori Jameson,Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Long Range", "1HC,1Fe,1UED", "Kill Warrant Scanner", 3, "Juri Ishmaak,Lori Jameson,Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Long Range", "1DED,1EA,1Ge", "Kill Warrant Scanner", 4, "Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Long Range", "1ACED,1Nb,1PCa", "Kill Warrant Scanner", 5, "Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Reinforced", "1Ni", "Kill Warrant Scanner", 1, "Juri Ishmaak,Lori Jameson,Tania Fortune,Bill Turner"),
            new MaterialCommoditiesList.EngineeringRecipe("Reinforced", "1Ni,1SE", "Kill Warrant Scanner", 2, "Juri Ishmaak,Lori Jameson,Tania Fortune,Bill Turner"),
            new MaterialCommoditiesList.EngineeringRecipe("Reinforced", "1Ni,1SE,1W", "Kill Warrant Scanner", 3, "Juri Ishmaak,Lori Jameson,Tania Fortune,Bill Turner"),
            new MaterialCommoditiesList.EngineeringRecipe("Reinforced", "1Mo,1W,1Zn", "Kill Warrant Scanner", 4, "Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Reinforced", "1HDC,1Mo,1Tc", "Kill Warrant Scanner", 5, "Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Shielded", "1WSE", "Kill Warrant Scanner", 1, "Juri Ishmaak,Lori Jameson,Tania Fortune,Bill Turner"),
            new MaterialCommoditiesList.EngineeringRecipe("Shielded", "1C,1SE", "Kill Warrant Scanner", 2, "Juri Ishmaak,Lori Jameson,Tania Fortune,Bill Turner"),
            new MaterialCommoditiesList.EngineeringRecipe("Shielded", "1C,1HDC,1SE", "Kill Warrant Scanner", 3, "Juri Ishmaak,Lori Jameson,Tania Fortune,Bill Turner"),
            new MaterialCommoditiesList.EngineeringRecipe("Shielded", "1PCo,1SS,1V", "Kill Warrant Scanner", 4, "Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Shielded", "1CoS,1CDC,1W", "Kill Warrant Scanner", 5, "Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Wide Angle", "1MS", "Kill Warrant Scanner", 1, "Juri Ishmaak,Lori Jameson,Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Wide Angle", "1Ge,1MS", "Kill Warrant Scanner", 2, "Juri Ishmaak,Lori Jameson,Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Wide Angle", "1CSD,1Ge,1MS", "Kill Warrant Scanner", 3, "Juri Ishmaak,Lori Jameson,Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Wide Angle", "1DSD,1ME,1Nb", "Kill Warrant Scanner", 4, "Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Wide Angle", "1CSF,1MC,1Sn", "Kill Warrant Scanner", 5, "Tania Fortune"),
            ...
            new MaterialCommoditiesList.EngineeringRecipe("Fast Scan", "1P", "Manifest Scanner", 1, "Juri Ishmaak,Lori Jameson,Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Fast Scan", "1FFC,1P", "Manifest Scanner", 2, "Juri Ishmaak,Lori Jameson,Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Fast Scan", "1FFC,1OSK,1P", "Manifest Scanner", 3, "Juri Ishmaak,Lori Jameson,Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Fast Scan", "1AEA,1FoC,1Mn", "Manifest Scanner", 4, "Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Fast Scan", "1AEC,1As,1RFC", "Manifest Scanner", 5, "Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Light Weight", "1P", "Manifest Scanner", 1, "Juri Ishmaak,Lori Jameson,Tania Fortune,Bill Turner"),
            new MaterialCommoditiesList.EngineeringRecipe("Light Weight", "1Mn,1SAll", "Manifest Scanner", 2, "Juri Ishmaak,Lori Jameson,Tania Fortune,Bill Turner"),
            new MaterialCommoditiesList.EngineeringRecipe("Light Weight", "1CCe,1Mn,1SAll", "Manifest Scanner", 3, "Juri Ishmaak,Lori Jameson,Tania Fortune,Bill Turner"),
            new MaterialCommoditiesList.EngineeringRecipe("Light Weight", "1CCo,1PA,1PLA", "Manifest Scanner", 4, "Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Light Weight", "1CCe,1PLA,1PRA", "Manifest Scanner", 5, "Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Long Range", "1Fe", "Manifest Scanner", 1, "Juri Ishmaak,Lori Jameson,Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Long Range", "1HC,1Fe", "Manifest Scanner", 2, "Juri Ishmaak,Lori Jameson,Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Long Range", "1HC,1Fe,1UED", "Manifest Scanner", 3, "Juri Ishmaak,Lori Jameson,Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Long Range", "1DED,1EA,1Ge", "Manifest Scanner", 4, "Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Long Range", "1ACED,1Nb,1PCa", "Manifest Scanner", 5, "Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Shielded", "1WSE", "Manifest Scanner", 1, "Juri Ishmaak,Lori Jameson,Tania Fortune,Bill Turner"),
            new MaterialCommoditiesList.EngineeringRecipe("Shielded", "1C,1SE", "Manifest Scanner", 2, "Juri Ishmaak,Lori Jameson,Tania Fortune,Bill Turner"),
            new MaterialCommoditiesList.EngineeringRecipe("Shielded", "1C,1HDC,1SE", "Manifest Scanner", 3, "Juri Ishmaak,Lori Jameson,Tania Fortune,Bill Turner"),
            new MaterialCommoditiesList.EngineeringRecipe("Shielded", "1PCo,1SS,1V", "Manifest Scanner", 4, "Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Shielded", "1CoS,1CDC,1W", "Manifest Scanner", 5, "Tania Fortune"),
            ...
            new MaterialCommoditiesList.EngineeringRecipe("Light Weight", "1P", "Prospector Limpet Controller", 1, "Tania Fortune,The Sarge,Ram Tah"),
            new MaterialCommoditiesList.EngineeringRecipe("Light Weight", "1Mn,1SAll", "Prospector Limpet Controller", 2, "Tania Fortune,The Sarge,Ram Tah"),
            new MaterialCommoditiesList.EngineeringRecipe("Light Weight", "1CCe,1Mn,1SAll", "Prospector Limpet Controller", 3, "Tania Fortune,The Sarge,Ram Tah"),
            new MaterialCommoditiesList.EngineeringRecipe("Light Weight", "1CCo,1PA,1PLA", "Prospector Limpet Controller", 4, "Tania Fortune,The Sarge,Ram Tah"),
            new MaterialCommoditiesList.EngineeringRecipe("Light Weight", "1CCe,1PLA,1PRA", "Prospector Limpet Controller", 5, "Tania Fortune,The Sarge"),
            new MaterialCommoditiesList.EngineeringRecipe("Reinforced", "1Ni", "Prospector Limpet Controller", 1, "Tania Fortune,The Sarge,Ram Tah"),
            new MaterialCommoditiesList.EngineeringRecipe("Reinforced", "1Ni,1SE", "Prospector Limpet Controller", 2, "Tania Fortune,The Sarge,Ram Tah"),
            new MaterialCommoditiesList.EngineeringRecipe("Reinforced", "1Ni,1SE,1W", "Prospector Limpet Controller", 3, "Tania Fortune,The Sarge,Ram Tah"),
            new MaterialCommoditiesList.EngineeringRecipe("Reinforced", "1Mo,1W,1Zn", "Prospector Limpet Controller", 4, "Tania Fortune,The Sarge,Ram Tah"),
            new MaterialCommoditiesList.EngineeringRecipe("Reinforced", "1HDC,1Mo,1Tc", "Prospector Limpet Controller", 5, "Tania Fortune,The Sarge"),
            new MaterialCommoditiesList.EngineeringRecipe("Shielded", "1WSE", "Prospector Limpet Controller", 1, "Tania Fortune,The Sarge,Ram Tah"),
            new MaterialCommoditiesList.EngineeringRecipe("Shielded", "1C,1SE", "Prospector Limpet Controller", 2, "Tania Fortune,The Sarge,Ram Tah"),
            new MaterialCommoditiesList.EngineeringRecipe("Shielded", "1C,1HDC", "Prospector Limpet Controller", 3, "Tania Fortune,The Sarge,Ram Tah"),
            new MaterialCommoditiesList.EngineeringRecipe("Shielded", "1PCo,1SS,1V", "Prospector Limpet Controller", 4, "Tania Fortune,The Sarge,Ram Tah"),
            new MaterialCommoditiesList.EngineeringRecipe("Shielded", "1CoS,1CDC,1W", "Prospector Limpet Controller", 5, "Tania Fortune,The Sarge"),
            ...
            new MaterialCommoditiesList.EngineeringRecipe("Light Weight", "1P", "Sensors", 1, "Juri Ishmaak,Lei Cheung,Lori Jameson,Tania Fortune,Bill Turner"),
            new MaterialCommoditiesList.EngineeringRecipe("Light Weight", "1Mn,1SAll", "Sensors", 2, "Juri Ishmaak,Lei Cheung,Lori Jameson,Tania Fortune,Bill Turner"),
            new MaterialCommoditiesList.EngineeringRecipe("Light Weight", "1CCe,1Mn,1SAll", "Sensors", 3, "Juri Ishmaak,Lori Jameson,Tania Fortune,Bill Turner"),
            new MaterialCommoditiesList.EngineeringRecipe("Light Weight", "1CCo,1PA,1PLA", "Sensors", 4, "Juri Ishmaak,Lori Jameson,Tania Fortune,Bill Turner"),
            new MaterialCommoditiesList.EngineeringRecipe("Light Weight", "1CCe,1PLA,1PRA", "Sensors", 5, "Lori Jameson,Tania Fortune,Bill Turner"),
            new MaterialCommoditiesList.EngineeringRecipe("Long Range", "1Fe", "Sensors", 1, "Juri Ishmaak,Lei Cheung,Lori Jameson,Tania Fortune,Bill Turner"),
            new MaterialCommoditiesList.EngineeringRecipe("Long Range", "1HC,1Fe", "Sensors", 2, "Juri Ishmaak,Lei Cheung,Lori Jameson,Tania Fortune,Bill Turner"),
            new MaterialCommoditiesList.EngineeringRecipe("Long Range", "1HC,1Fe,1UED", "Sensors", 3, "Juri Ishmaak,Lori Jameson,Tania Fortune,Bill Turner"),
            new MaterialCommoditiesList.EngineeringRecipe("Long Range", "1DED,1EA,1Ge", "Sensors", 4, "Juri Ishmaak,Lori Jameson,Tania Fortune,Bill Turner"),
            new MaterialCommoditiesList.EngineeringRecipe("Long Range", "1ACED,1Nb,1PCa", "Sensors", 5, "Lori Jameson,Tania Fortune,Bill Turner"),
            new MaterialCommoditiesList.EngineeringRecipe("Wide Angle", "1MS", "Sensors", 1, "Juri Ishmaak,Lei Cheung,Lori Jameson,Tania Fortune,Bill Turner"),
            new MaterialCommoditiesList.EngineeringRecipe("Wide Angle", "1Ge,1MS", "Sensors", 2, "Juri Ishmaak,Lei Cheung,Lori Jameson,Tania Fortune,Bill Turner"),
            new MaterialCommoditiesList.EngineeringRecipe("Wide Angle", "1CSD,1Ge,1MS", "Sensors", 3, "Juri Ishmaak,Lori Jameson,Tania Fortune,Bill Turner"),
            new MaterialCommoditiesList.EngineeringRecipe("Wide Angle", "1DSD,1ME,1Nb", "Sensors", 4, "Juri Ishmaak,Lori Jameson,Tania Fortune,Bill Turner"),
            new MaterialCommoditiesList.EngineeringRecipe("Wide Angle", "1CSF,1MC,1Sn", "Sensors", 5, "Lori Jameson,Tania Fortune,Bill Turner"),
            ...
            new MaterialCommoditiesList.EngineeringRecipe("Fast Scan", "1P", "Wake Scanner", 1, "Juri Ishmaak,Lori Jameson,Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Fast Scan", "1FFC,1P", "Wake Scanner", 2, "Juri Ishmaak,Lori Jameson,Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Fast Scan", "1FFC,1OSK,1P", "Wake Scanner", 3, "Juri Ishmaak,Lori Jameson,Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Fast Scan", "1AEA,1FoC,1Mn", "Wake Scanner", 4, "Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Fast Scan", "1AEC,1As,1RFC", "Wake Scanner", 5, "Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Light Weight", "1P", "Wake Scanner", 1, "Juri Ishmaak,Lori Jameson,Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Light Weight", "1Mn,1SAll", "Wake Scanner", 2, "Juri Ishmaak,Lori Jameson,Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Light Weight", "1CCe,1Mn,1SAll", "Wake Scanner", 3, "Juri Ishmaak,Lori Jameson,Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Light Weight", "1CCo,1PA,1PLA", "Wake Scanner", 4, "Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Light Weight", "1CCe,1PLA,1PRA", "Wake Scanner", 5, "Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Long Range", "1Fe", "Wake Scanner", 1, "Juri Ishmaak,Lori Jameson,Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Long Range", "1HC,1Fe", "Wake Scanner", 2, "Juri Ishmaak,Lori Jameson,Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Long Range", "1HC,1Fe,1UED", "Wake Scanner", 3, "Juri Ishmaak,Lori Jameson,Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Long Range", "1DED,1EA,1Ge", "Wake Scanner", 4, "Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Long Range", "1ACED,1Nb,1PCa", "Wake Scanner", 5, "Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Reinforced", "1Ni", "Wake Scanner", 1, "Juri Ishmaak,Lori Jameson,Tania Fortune,Bill Turner"),
            new MaterialCommoditiesList.EngineeringRecipe("Reinforced", "1Ni,1Se", "Wake Scanner", 2, "Juri Ishmaak,Lori Jameson,Tania Fortune,Bill Turner"),
            new MaterialCommoditiesList.EngineeringRecipe("Reinforced", "1Ni,1Se,1W", "Wake Scanner", 3, "Juri Ishmaak,Lori Jameson,Tania Fortune,Bill Turner"),
            new MaterialCommoditiesList.EngineeringRecipe("Reinforced", "1Mo,1W,1Zn", "Wake Scanner", 4, "Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Reinforced", "1HDC,1Mo,1Tc", "Wake Scanner", 5, "Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Shielded", "1WSE", "Wake Scanner", 1, "Juri Ishmaak,Lori Jameson,Tania Fortune,Bill Turner"),
            new MaterialCommoditiesList.EngineeringRecipe("Shielded", "1C,1SE", "Wake Scanner", 2, "Juri Ishmaak,Lori Jameson,Tania Fortune,Bill Turner"),
            new MaterialCommoditiesList.EngineeringRecipe("Shielded", "1C,1HDC", "Wake Scanner", 3, "Juri Ishmaak,Lori Jameson,Tania Fortune,Bill Turner"),
            new MaterialCommoditiesList.EngineeringRecipe("Shielded", "1PCo,1SS,1V", "Wake Scanner", 4, "Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Shielded", "1CoS,1CDC,1W", "Wake Scanner", 5, "Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Wide Angle", "1MS", "Wake Scanner", 1, "Juri Ishmaak,Lori Jameson,Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Wide Angle", "1Ge,1MS", "Wake Scanner", 2, "Juri Ishmaak,Lori Jameson,Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Wide Angle", "1CSD,1Ge,1MS", "Wake Scanner", 3, "Juri Ishmaak,Lori Jameson,Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Wide Angle", "1DSD,1ME,1Nb", "Wake Scanner", 4, "Tania Fortune"),
            new MaterialCommoditiesList.EngineeringRecipe("Wide Angle", "1CSF,1MC,1Sn", "Wake Scanner", 5, "Tania Fortune"),
        };
