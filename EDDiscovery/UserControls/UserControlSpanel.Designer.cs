...
namespace EDDiscovery.UserControls
{
    partial class UserControlSPanel
    {
        ...
        private void InitializeComponent()
        {
			...
			this.goldilocksToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem();
            ...
            this.goldilocksToolStripMenuItem,
			...
			// 
			// goldilocksToolStripMenuItem
			// 
			this.goldilocksToolStripMenuItem.Checked = true;
			this.goldilocksToolStripMenuItem.CheckOnClick = true;
			this.goldilocksToolStripMenuItem.CheckState = System.Windows.Forms.CheckState.Checked;
			this.goldilocksToolStripMenuItem.Name = "goldilocksToolStripMenuItem";
			this.goldilocksToolStripMenuItem.Size = new System.Drawing.Size(180, 22);
			this.goldilocksToolStripMenuItem.Text = "Goldilocks";
			this.goldilocksToolStripMenuItem.CheckStateChanged += new System.EventHandler(this.goldilocksToolStripMenuItem_CheckStateChanged);
			// 
			...
			this.metalRichToolStripMenuItem.Text = "Metal Rich Planets";
			...
			this.earthLikeToolStripMenuItem.Text = "Earth Like Worlds";
		...
		private System.Windows.Forms.ToolStripMenuItem goldilocksToolStripMenuItem;
