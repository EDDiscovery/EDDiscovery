    ...
    public static class EDDHelp 
    {
        ...
        static private JToken defaulthelp = new JObject()
        {
            ...
            ["Panels"] = new JArray()
            {
                ...
                new JObject() { ["panel"] = "Materials", ["wiki"] = "/Using-the-Materials-Panel", ["video"] = "https://youtu.be/q_a1gmY9VGM" },
                new JObject() { ["panel"] = "Commodities", ["wiki"] = "/Using-the-Commodities-Panel", ["video"] = "https://youtu.be/q_a1gmY9VGM" },
