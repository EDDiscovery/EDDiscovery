...
//•	StarClass: star type(only for a hyperspace jump)
    ...
    public class JournalStartJump : JournalEntry
    {
        ...
        public override System.Drawing.Bitmap Icon { get { return EDDiscovery.Properties.Resources.startjump; } }

        public override void FillInformation(out string summary, out string info, out string detailed) //V
        {
            summary = EventTypeStr.SplitCapsWord();
            info = Tools.FieldBuilder("",JumpType , "< to " , StarSystem, "Class:" , StarClass);
            detailed = "";
        }
    }
}
