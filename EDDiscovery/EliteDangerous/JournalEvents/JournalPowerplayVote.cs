...
namespace EDDiscovery.EliteDangerous.JournalEvents
{
    ...
    public class JournalPowerplayVote : JournalEntry
    {
        ...
        public override System.Drawing.Bitmap Icon { get { return EDDiscovery.Properties.Resources.powerplayvote; } }

        public override void FillInformation(out string summary, out string info, out string detailed) //U
        {
            summary = EventTypeStr.SplitCapsWord();
            info = Tools.FieldBuilder("", Power, "System:", System, "Votes:", Votes);
            detailed = "";
        }
    }
}
