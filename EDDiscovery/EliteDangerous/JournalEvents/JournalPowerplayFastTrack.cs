...
namespace EDDiscovery.EliteDangerous.JournalEvents
{
    ...
    public class JournalPowerplayFastTrack : JournalEntry, ILedgerJournalEntry
    {
        ...
        public override System.Drawing.Bitmap Icon { get { return EDDiscovery.Properties.Resources.powerplayfasttrack; } }
        ...
        public override void FillInformation(out string summary, out string info, out string detailed) //U
        {
            ...
            info = Tools.FieldBuilder("", Power, "Cost:; credits", Cost);
            detailed = "";
        }
    }
}
