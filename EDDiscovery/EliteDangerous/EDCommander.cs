...
namespace EDDiscovery2
{
    ...
    public class EDCommander
    {
        ...
        public static int CurrentCmdrID
        {
            get
            {
                return EDDConfig.Instance.CurrentCmdrID;
            }
            set
            {
                EDDConfig.Instance.CurrentCmdrID = value;
            }
        }
        ...
        public static void Update(int cmdrid, string name = null, string edsmname = null, string apikey = null, string netlogdir = null, string journaldir = null, bool? synctoedsm = null, bool? syncfromedsm = null, bool? synctoeddn = null)
        {
            EDCommander cmdr = GetCommander(cmdrid);
            if (cmdr != null)
            {
                cmdr = new EDCommander(
                    id: cmdrid,
                    Name: name ?? cmdr.name,
                    APIKey: apikey ?? cmdr.apikey,
                    SyncToEDSM: synctoedsm ?? cmdr.syncToEdsm,
                    SyncFromEdsm: syncfromedsm ?? cmdr.syncFromEdsm,
                    SyncToEddn: synctoeddn ?? cmdr.syncToEddn,
                    edsmName: edsmname ?? cmdr.edsmname,
                    journaldir: journaldir ?? cmdr.journalDir,
                    netlogdir: netlogdir ?? cmdr.netLogDir,
        ...
        public static void Update(IEnumerable<EDCommander> cmdrlist)
        {
            if (cmdrlist == null)
                return;
        ...
        public EDCommander(int id, string Name, string APIKey, bool SyncToEDSM, bool SyncFromEdsm, bool SyncToEddn, string edsmName = null, string journaldir = null, string netlogdir = null, bool deleted = false)
        {
            this.nr = id;
            this.name = Name;
