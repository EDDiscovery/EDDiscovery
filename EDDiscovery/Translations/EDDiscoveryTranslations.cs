...
namespace EDDiscovery
{
    public enum EDTx
    {
        ...
        UserControlStats_OwnedShipCount, // Owned ships
        UserControlStats_SpentOnSuits, // Spent on Suits
        UserControlStats_SpentOnWeapons, // Spent on Weapons
        UserControlStats_SpentOnSuitConsumables, // Spent on Suit Consumables
        UserControlStats_SuitsOwned, // Suits Owned
        UserControlStats_WeaponsOwned, // Weapons Owned
        UserControlStats_SpentOnPremiumStock, // Spent on Premium Stock
        UserControlStats_PremiumStockBought, // Premium Stock bought        
        ...
        UserControlStats_DropshipsTaken, // Dropships Taken
        UserControlStats_DropshipsBooked, //Dropships Booked
        UserControlStats_DropshipsCancelled, //Dropships Cancelled
        UserControlStats_ConflictZoneHigh, // High Intensity Conflict Zones fought
        UserControlStats_ConflictZoneMedium, // Medium Intensity Conflict Zones fought
        UserControlStats_ConflictZoneLow, // Low Intensity Conflict Zones fought
        UserControlStats_ConflictZoneTotal, // Total Conflict Zones fought
        UserControlStats_ConflictZoneHighWins, // High Intensity Conflict Zones won
        UserControlStats_ConflictZoneMediumWins, // Medium Intensity ConflictZones won
        UserControlStats_ConflictZoneLowWins, // Low Intensity Conflict Zones won
        UserControlStats_ConflictZoneTotalWins, // Total Conflict Zones won
        UserControlStats_SettlementDefended, // Settlements Defended
        UserControlStats_SettlementConquered, // Settlements Conquered
        UserControlStats_OnFootSkimmersKilled, // Skimmers killed on Foot
        UserControlStats_OnFootScavsKilled, // Scavengers killed on Foot
        ...
        UserControlStats_MalwareUploaded, // Malware Uploaded
        UserControlStats_SettlementsStateShutdown, // Settlements shut down
        UserControlStats_ProductionSabotage, // Production Sabotaged
        UserControlStats_ProductionTheft, // Production Thefts
        UserControlStats_TotalMurders, // Total Murders
        UserControlStats_CitizensMurdered, // Citizens Murdered
        UserControlStats_OmnipolMurdered, // Omnipol Murdered 
        UserControlStats_GuardsMurdered, //Guards Murdered
        UserControlStats_DataStolen, // Data Stolen
        UserControlStats_GoodsStolen, // Goods Stolen
        UserControlStats_SampleStolen, // Production Samples Stolen
        UserControlStats_TotalStolen, // Total Inventory Items Stolen
        UserControlStats_TurretsDestroyed, // Turrets Destroyed
        UserControlStats_TurretsOverloaded, // Turrets Overloaded
        UserControlStats_TurretsTotal, // Total Turrets shut down
        UserControlStats_ValueStolenStateChange, // Stolen Items Value
        UserControlStats_ProfilesCloned, // ProfilesCloned
        ...
        UserControlStats_DataSold, // Data Sold
        UserControlStats_TradingGoodsSold, // Goods Sold
        UserControlStats_AssetsSold, // Assets Sold
        ...
        UserControlStats_ShuttleJourneys, // Shuttle Journeys
        UserControlStats_ShuttleDistanceTravelled, // Shuttle Distance Travelled
        UserControlStats_SpentOnShuttles, // Credits Spent on Shuttles
        UserControlStats_FirstFootfalls, // First Footfalls
        UserControlStats_PlanetFootfalls, // Planets walked on
        UserControlStats_SettlementsVisited, // Settlements docked at
        ...
        UserControlStats_SalvageLegalPOI, // Legal Salvage Value - Surface
        UserControlStats_SalvageLegalSettlements, // Legal Salvage Value - Settlements
        UserControlStats_SalvageIllegalPOI, // Illegal Salvage Value - Surface
        UserControlStats_SalvageIllegalSettlements, // Illegal Salvage Value - Settlements
        UserControlStats_MaglocksOpened, // Maglocks cut
        UserControlStats_PanelsOpened, // Panels cut
        UserControlStats_SettlementsStateFireOut, // Settlement Fires extinguished
        UserControlStats_SettlementsStateReboot, // Settlements rebooted
        ...
        UserControlStats_SuitModsApplied, // Suit Modifications Applied
        UserControlStats_WeaponModsApplied, // Weapon Modifications Applied
        UserControlStats_SuitsUpgraded, // Suit Upgrades Applied
        UserControlStats_WeaponsUpgraded, // Weapon Upgrades Applied
        UserControlStats_SuitsUpgradedFull, // Suits fully Upgraded
        UserControlStats_WeaponsUpgradedFull, // Weapons fully Upgraded
        UserControlStats_SuitModsAppliedFull, // Suits fully Modified
        UserControlStats_WeaponModsAppliedFull, // Weapons fully Modified
        ...
        UserControlStats_TradesCompleted, // Material Trades Completed
        UserControlStats_MaterialsTraded, // Materials Traded
        UserControlStats_EncodedMaterialsTraded, // Encoded Materials Traded
        UserControlStats_RawMaterialsTraded, // Raw Materials Traded
        UserControlStats_G1MaterialsTraded, // Grade 1 Materials Traded
        UserControlStats_G2MaterialsTraded, // Grade 2 Materials Traded
        UserControlStats_G3MaterialsTraded, // Grade 3 Materials Traded
        UserControlStats_G4MaterialsTraded, // Grade 4 Materials Traded
        UserControlStats_G5MaterialsTraded, // Grade 5 Materials Traded        
        UserControlStats_CreditsEarned, // Profits from CQC
        UserControlStats_CQCTimePlayed, // Time Played
        UserControlStats_KDRatio, // K/D Ratio
        UserControlStats_Kills, // Kills
        UserControlStats_Win, // Win/Loss
        UserControlStats_EXPORTTOTAL, // Total Commodities Exported
        UserControlStats_IMPORTTOTAL, // Total Commodities Imported
        UserControlStats_TRADEPROFITTOTAL, // Credits earned from Commodities
        UserControlStats_TRADESPENDTOTAL, // Credits spent on Commodities
        UserControlStats_STOLENPROFITTOTAL, // Credits earned from Stolen Goods
        UserControlStats_STOLENSPENDTOTAL, // Credits spent on Stolen Goods
        UserControlStats_DISTANCETRAVELLED, // Total Travel Distance
        UserControlStats_TOTALJUMPS, // Number of Carrier Jumps
        UserControlStats_SHIPYARDSOLD, // Total Ships Sold
        UserControlStats_SHIPYARDPROFIT, // Credits earned from Shipyard
        UserControlStats_OUTFITTINGSOLD, // Total Modules Sold
        UserControlStats_OUTFITTINGPROFIT, // Credits earned from Outfitting
        UserControlStats_REARMTOTAL, // Total Ships Restocked
        UserControlStats_REFUELTOTAL, // Total Ships Refuelled
        UserControlStats_REFUELPROFIT, // Credits earned from Refuelling
        UserControlStats_REPAIRSTOTAL, // Total Ships Repaired
        UserControlStats_VOUCHERSREDEEMED, // Redemption Office Exchanges
        UserControlStats_VOUCHERSPROFIT, // Redemption Office Payouts
        UserControlStats_OrganicGenusEncountered, // Unique Genus Encountered
        UserControlStats_OrganicSpeciesEncountered, // Unique Species Encountered
        UserControlStats_OrganicVariantEncountered, // Unique Variants Encountered
        UserControlStats_OrganicDataProfits, // Profit from Organic Data
        UserControlStats_OrganicData, // Organic Data Registered
        UserControlStats_FirstLoggedProfits, // Profit from First Logged
        UserControlStats_FirstLogged, // First Logged
        UserControlStats_OrganicSystems, // Systems with Organic Life
        UserControlStats_OrganicPlanets, // Planets with Organic Life
        UserControlStats_OrganicGenus, // Unique Genus Data Logged
        UserControlStats_OrganicSpecies, // Unique Species Data Logged
