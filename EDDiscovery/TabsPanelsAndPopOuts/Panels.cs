...
namespace EDDiscovery
{
    static public class PanelInformation
    {
        ...
        static private List<PanelInfo> paneldefinition = new List<PanelInfo>()
        {
            ...
            { new PanelInfo( PanelIDs.Log , typeof(Log),"Log", "Log", "Log of program information" ) },
            ...
            { new PanelInfo( PanelIDs.StarList, typeof(StarList), "Visited Stars", "StarList", "Visited Star list") },
            ...
            { new PanelInfo( PanelIDs.Modules, typeof(ShipsAndModules), "Ships/Loadout", "Modules", "Ships and their loadouts plus stored modules") },
            ...
            { new PanelInfo( PanelIDs.Surveyor, typeof(SurveyorPanel), "Surveyor", "Surveyor", "Surveyor - Exploration and route overlay"  ) },
