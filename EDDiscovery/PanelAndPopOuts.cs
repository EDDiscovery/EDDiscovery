...
namespace EDDiscovery.Forms
{
    public class PanelInformation
    {
        ...
        static public List<PanelInfo> PanelList = new List<PanelInfo>()
        {
            ...
            { new PanelInfo( PanelIDs.Radar, typeof(UserControlRadar), "Radar", "Radar", EDDiscovery.Properties.Resources.radar,"3D Map of nearest stars") },
            { new PanelInfo( PanelIDs.Plot, typeof(UserControlPlot), "Plot", "Plot", EDDiscovery.Properties.Resources.plot,"2D Plot of nearest stars, from three views") },
