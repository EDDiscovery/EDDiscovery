...
namespace EDDiscovery.Forms
{
    public class PanelInformation
    {
        ...
        static public List<PanelInfo> PanelList = new List<PanelInfo>()
        {
            ...
            { new PanelInfo( PanelIDs.StarsInRange, typeof(UserControlStarsInRange), "Stars In Range", "StarsInRange", EDDiscovery.Properties.Resources.starsinrange,"Display the stars inside the selected radius") },
