    ...
    public class ExportScan : BaseUtils.CVSWrite
    {
        ...
        override public bool GetData(Object d)
        {
            ...
            if (EDSMList == false)
            {
                ...
                var entries = JournalEntry.GetByEventType(JournalTypeEnum.Scan, EDCommander.CurrentCmdrID,
            ...
            try
            {
                using (StreamWriter writer = new StreamWriter(filename))
                {
                    if (IncludeHeader)
                    {
                        ...
                        writer.Write("Estimated Value" + delimiter);
                    ...
                    foreach (JournalScan je in scans)
                    {
                        ...
                        writer.Write(MakeValueCsvFriendly(scan.EstimatedValue()));
