...
namespace EDDiscovery.Actions
{
    class ActionScan : ActionBase
    {
        ...
        {
            string promptValue = configFuncs.PromptSingleLine("Scan system name", UserData, "Configure Scan Command" ,cp.Icon);
            if (promptValue != null)
            {
    ...
    class ActionStar : ActionBase
    {
        ...
        public override bool Configure(ActionCoreController cp, List<BaseUtils.TypeHelpers.PropertyNameInfo> eventvars, ActionConfigFuncs configFuncs)
        {
            string promptValue = configFuncs.PromptSingleLine("Star system name", UserData, "Configure Star Command" , cp.Icon);
            if (promptValue != null)
            {
                userdata = promptValue;
            }
