...
namespace EDDiscovery.Actions
{
    public partial class ActionPackEditorForm : Form
    {
        ...
        public void Init(string t, ActionFile file, List<Tuple<string, string>> ev, EDDiscoveryForm form , List<string> an)
        {
            actionfile = file;
            events = ev;
            discoveryform = form;
        ...
        private void CreateUserControl(Group g, Condition c)
        {
            ...
            g.usercontrol.Init(c, groupeventlist[g.grouptype.Text], actionfile, discoveryform, additionalnames);
        ...
        private void comboBoxCustomEditProg_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (comboBoxCustomEditProg.Enabled)
            {
                ...
                else
                {
                    ...
                    apf.Init("Action program " , discoveryform, additionalnames, actionfile.name, p, actionfile.actionprogramlist.GetActionProgramList(), "", ModifierKeys.HasFlag(Keys.Shift));
        ...
        {
            if (!actionfile.actionprogramlist.EditProgram(s, discoveryform, actionfile.name))
        ...
        private void buttonInstallationVars_Click(object sender, EventArgs e)
        {
            ...
            avf.Init("Configuration items for installation - specialist use", discoveryform.theme, actionfile.installationvariables, showone: false);
    ...
    public class UserControlAB : UserControl
    {
        ...
        public void Init(Condition cond, List<string> events, ActionFile file, EDDiscoveryForm form, List<string> an)
        {
        ...
        public List<string> GetAdditionalNames(string evname)
        {
            List<string> fieldnames = new List<string>(additionalnames);
            fieldnames.Sort();
            List<string> classnames = Tools.GetPropertyFieldNames(EDDiscovery.EliteDangerous.JournalEntry.TypeOfJournalEntry(evname), "EventClass_");
            if (classnames != null)
    ...
    public class UserControlAction : UserControlAB
    {
        ...
        private void Progedit_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                apf.Init("Action program " , discoveryform, GetAdditionalNames(eventtype.Text), actionfile.name , p, actionfile.actionprogramlist.GetActionProgramList(), suggestedname, ModifierKeys.HasFlag(Keys.Shift));
    ...
    public class UserControlProgram : UserControlAction
    {
        ...
        private void Condition_Click(object sender, EventArgs e)
        {
            ...
            frm.InitCondition("Action condition", GetAdditionalNames(eventtype.Text), discoveryform, cd);
