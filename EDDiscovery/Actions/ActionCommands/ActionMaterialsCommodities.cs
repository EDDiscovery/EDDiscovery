...
{ 
    public class ActionMaterialsCommoditiesBase : Action
    {
        ...
        {
            string promptValue = Forms.PromptSingleLine.ShowDialog(parent, discoveryform.theme, "JID of event", UserData, (commodities) ? "Configure Commodities Command" : "Configure Material Command");
            if (promptValue != null)
            {
