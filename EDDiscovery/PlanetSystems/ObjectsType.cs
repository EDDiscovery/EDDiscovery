    ...
    public class ObjectsType
    {
        ...
        static public List<ObjectsType> GetAllTypes()
        {
            ObjectsType[] objs = new ObjectsType[]
            {
                ...
                new ObjectsType(ObjectTypesEnum.Unknown_Star, "Class?", "Unknown star", ""),
                new ObjectsType(ObjectTypesEnum.Star_O, "ClassO", "Class O Star", "Class O type stars are the most luminous and massive main sequence stars in the galaxy. They range in mass from 15 to 90 solar masses and burn very brightly indeed, with a surface temperature reaching 52,000 K so appear very blue. They are very short lived with lifetimes of 1 - 10 million years, ending in supernova."),
                new ObjectsType(ObjectTypesEnum.Star_B, "ClassB", "Class B Star", "Class B stars are very luminous blue-white stars. They range in mass from 2 to 16 solar masses and have a surface temperature reaching 30,000 K. Their lifetimes are shorter than most main sequence stars."),
                new ObjectsType(ObjectTypesEnum.Star_A, "ClassA", "Class A Star", "Class A stars are hot white or bluish white main sequence stars. They range in mass from 1.4 to 2.1 solar masses and have a surface temperature reaching 10,000 K."),
                new ObjectsType(ObjectTypesEnum.Star_F, "ClassF", "Class F Star", "Class F stars are white main sequence stars. They range in mass from 1 to 1.4 solar masses and have a surface temperature reaching 7,600 K."),
                new ObjectsType(ObjectTypesEnum.Star_G, "ClassG", "Class G Star", "Class G stars are white-yellow main sequence stars. They range in mass from 0.8 to 1.2 solar masses and have a surface temperature reaching 6,000 K."),
                new ObjectsType(ObjectTypesEnum.Star_K, "ClassK", "Class K Star", "Class K stars are yellow-orange main sequence stars with a long and generally stable life. They range in mass from 0.6 to 0.9 solar masses and have a surface temperature reaching 5,000 K."),
                new ObjectsType(ObjectTypesEnum.Star_M, "ClassM", "Class M Star", "Class M stars are red stars that form the bulk of the main sequence stars in the galaxy. Their mass is low, as is their surface temperature."),
                new ObjectsType(ObjectTypesEnum.Star_L, "ClassL", "Class L Dwarf", "Class L dwarfs are dwarf stars that are cooler than M class stars. They are on the borderline of supporting fusion of hydrogen in their cores, and their temperatures range from 1,300 K to 2,400 K, cool enough to have alkaline metals and metal hydrides in their atmospheres."),
                new ObjectsType(ObjectTypesEnum.Star_T, "ClassT", "Class T Dwarf", "Class T dwarfs are brown dwarfs with a surface temperature between 700 and 1,300 K. They are sometimes known as Methane Dwarfs due to the prominence of methane in their composition. They are on the borderline between what might be considered a very large gas giant planet and a star."),
                new ObjectsType(ObjectTypesEnum.Star_Y, "ClassY", "Class Y Dwarf", "Class Y dwarfs are the coolest of the brown dwarfs. Surface temperatures are less than 700 K, and are effectively very large gas giant planets, with some stellar properties."),
                new ObjectsType(ObjectTypesEnum.Star_TTauri , "ClassTT", "T Tauri Star", "T Tauri type stars are very young stars which are in the process of gravitational contraction."),
                new ObjectsType(ObjectTypesEnum.Star_GA, "ClassGA", "Class A Supergiant Star", "Class A blue-white supergiant star. It is approaching the end of its life and hydrogen burning has stopped in its core, and star has begun expanding towards being red supergiant."),
                new ObjectsType(ObjectTypesEnum.Star_GF, "ClassGF", "Class F Supergiant Star", "Class F yellow-white supergiant star. It is approaching the end of its life and hydrogen burning has stopped in its core, and star has begun expanding towards being red supergiant."),
                new ObjectsType(ObjectTypesEnum.Star_GK, "ClassGK", "Class K Giant Star", "Orange giant stars with spectral type K. Orange giants like this are reaching the end of their lives, and have moved off the main sequence. Hydrogen has stopped fusing in the core, leaving a collapsed core of degenerate helium, and hydrogen burning is taking place in an outer shell as the star continues to expand."),
                new ObjectsType(ObjectTypesEnum.Star_GM, "ClassGM", "Class M Giant Star", "Red giant star. Red giants are in the latter part of their lives. Hydrogen has stopped fusing in their degenerate helium cores and has moved to an outer shell, causing the star to expand. The outer atmosphere is inflated and tenuous, and the surface temperature is below 5,000 K."),
                new ObjectsType(ObjectTypesEnum.Star_SGM, "ClassSGM", "Class M Supergiant Star", "Red supergiants are massive stars near the end of their lives. They have entered a helium burning phase, where helium is fused into carbon and oxygen. They have enormous sizes swelling up to many hundred solar diameters - up to 7 AU in some cases. their out reaches can be quite cool - typically 3500-4500 K."),
                new ObjectsType(ObjectTypesEnum.Star_AeBe, "ClassH", "Herbig Ae/Be Star", "Herbig Ae/Be stars are young stars typically less than 10 million years old with characteristics of either A or B class main sequence stars. They are usually between 2 and 8 solar masses. The mass of the proto-star determines its spectral class when it joins the main sequence."),
                new ObjectsType(ObjectTypesEnum.Star_W, "ClassW", "Wolf-Rayet Star", "Wolf-Rayet class stars are massive stars that are nearing the end of their life cycle and have moved out of their hydrogen-burning phase. They were once over 20 solar masses but now shed considerable amounts of material through solar wind. Their surface temperature can reach 200,000 K, so they appear a brilliant blue."),
                new ObjectsType(ObjectTypesEnum.Star_WN, "ClassWN", "Wolf-Rayet N Star", "Wolf-Rayet class stars are massive stars that are nearing the end of their life cycle and have moved out of their hydrogen-burning phase. They were once over 20 solar masses but now shed considerable amounts of material through solar wind. Their surface temperature can reach 200,000 K, so they appear a brilliant blue. This star is a variant of the Wolf-Rayet stars whose spectrum is dominated by ionised nitrogen and helium lines."),
                new ObjectsType(ObjectTypesEnum.Star_WNC, "ClassWNC", "Wolf-Rayet NC Star", "Wolf-Rayet class stars are massive stars that are nearing the end of their life cycle and have moved out of their hydrogen-burning phase. They were once over 20 solar masses but now shed considerable amounts of material through solar wind. Their surface temperature can reach 200,000 K, so they appear a brilliant blue. This star is a variant of the Wolf-Rayet stars whose spectrum is dominated by ionised nitrogen, carbon-oxygen and helium lines."),
                new ObjectsType(ObjectTypesEnum.Star_WC, "ClassWC", "Wolf-Rayet C Star", "Wolf-Rayet class stars are massive stars that are nearing the end of their life cycle and have moved out of their hydrogen-burning phase. They were once over 20 solar masses but now shed considerable amounts of material through solar wind. Their surface temperature can reach 200,000 K, so they appear a brilliant blue. This star is a variant of the Wolf-Rayet stars whose spectrum is dominated by ionised carbon lines."),
                new ObjectsType(ObjectTypesEnum.Star_WO, "ClassWO", "Wolf-Rayet O Star", "Wolf-Rayet class stars are massive stars that are nearing the end of their life cycle and have moved out of their hydrogen-burning phase. They were once over 20 solar masses but now shed considerable amounts of material through solar wind. Their surface temperature can reach 200,000 K, so they appear a brilliant blue. This star is a variant of the Wolf-Rayet stars whose spectrum is dominated by ionised oxygen lines."),
                new ObjectsType(ObjectTypesEnum.Star_GS, "ClassGS", "Class S Giant Star", "Class S stars are a late-type giant star (similar to class K5–M) whose spectrum displays bands from zirconium oxide, in addition to the titanium oxide bands characteristically exhibited by K and M class giant stars."),
                new ObjectsType(ObjectTypesEnum.Star_S, "ClassS", "Class S Star", "S class stars are late sequence stars that were once M class stars and have begun the cycle towards becoming a carbon star, a star nearing the end of its life."),
                new ObjectsType(ObjectTypesEnum.Star_MS, "ClassMS", "Class MS Star", "MS class stars are late sequence stars having progressed from the S class stage of their life cycle and heading towards becoming a carbon star, a star nearing the end of its stellar life."),
                new ObjectsType(ObjectTypesEnum.Star_C, "ClassC", "Carbon Star", "Carbon class stars are stars approaching the end of their life. A carbon star is a late-type star similar to a red giant (or occasionally to a red dwarf) whose atmosphere contains more carbon than oxygen; the two elements combine in the upper layers of the star, forming carbon monoxide, which consumes all the oxygen in the atmosphere, leaving carbon atoms free to form other carbon compounds, giving the star a \"sooty\" atmosphere and a strikingly ruby red appearance. The surface temperature is rarely higher than 4300 K."),
                new ObjectsType(ObjectTypesEnum.Star_CN, "ClassCN", "Carbon C-N Star", "Class C-N stars are variants of carbon class stars, stars that are approaching the end of their stellar lives as hydrogen fusion begins to stop. They were once K or M type stars that have degenerated to the carbon phase of their life cycle."),
                new ObjectsType(ObjectTypesEnum.Star_DA, "ClassDA", "Class DA White Dwarf", "White Dwarf stars are stellar remnants. Nuclear fusion has now ceased, and in the absence of radiation pressure the core has collapsed to a tiny fraction of the diameter of the original star, heating it up greatly before it begins its slow cooling down phase. Surface temperatures are usually between 8,000 K and 40,000K so these stellar remnants are blue-white. Class DA stars are white dwarf stars with a hydrogen rich atmosphere."),
                new ObjectsType(ObjectTypesEnum.Star_DB, "ClassDB", "Class DB White Dwarf", "White Dwarf stars are stellar remnants. Nuclear fusion has now ceased, and in the absence of radiation pressure the core has collapsed to a tiny fraction of the diameter of the original star, heating it up greatly before it begins its slow cooling down phase. Surface temperatures are usually between 8,000K and 40,000K so these stellar remnants are blue-white. Class DB stars are white dwarf stars with a helium rich atmosphere with neutral helium emission lines."),
                new ObjectsType(ObjectTypesEnum.Star_DAB, "ClassDAB", "Class DAB White Dwarf", "White Dwarf stars are stellar remnants. Nuclear fusion has now ceased, and in the absence of radiation pressure the core has collapsed to a tiny fraction of the diameter of the original star, heating it up greatly before it begins its slow cooling down phase. Surface temperatures are usually between 8,000K and 40,000K so these stellar remnants are blue-white. Class DAB stars are white dwarf stars with hydrogen and helium rich atmospheres and neutral helium emission lines."),
                new ObjectsType(ObjectTypesEnum.Star_DC, "ClassDC", "Class DC White Dwarf", "White Dwarf stars are stellar remnants. Nuclear fusion has now ceased, and in the absence of radiation pressure the core has collapsed to a tiny fraction of the diameter of the original star, heating it up greatly before it begins its slow cooling down phase. Surface temperatures are usually between 8,000K and 40,000K so these stellar remnants are blue-white."),
                new ObjectsType(ObjectTypesEnum.Star_DCV, "ClassDCV", "Class DC Variable White Dwarf", "White Dwarf stars are stellar remnants. Nuclear fusion has now ceased, and in the absence of radiation pressure the core has collapsed to a tiny fraction of the diameter of the original star, heating it up greatly before it begins its slow cooling down phase. Surface temperatures are usually between 8,000K and 40,000K so these stellar remnants are blue-white. Class DCV stars are white dwarfs with varying luminosity."),
                new ObjectsType(ObjectTypesEnum.Star_N, "ClassN", "Neutron Star", "Neutron stars are the stellar remnants of massive stars that have reached the end of their lives. Once nuclear fusion was exhausted, the star collapsed into a tiny volume. Because of its high mass, the matter has collapsed into an extremely high density state made up entirely of neutrons, though with insufficient mass to become a black hole."),
