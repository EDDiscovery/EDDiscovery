...
namespace EDDiscovery
{
    ...
    {
        protected ExtendedControls.ToolStripCustomColourTable _colortable;
        ...
        public EDDToolStripRenderer() : base(new ExtendedControls.ToolStripCustomColourTable())
        {
            this._colortable = (ExtendedControls.ToolStripCustomColourTable)ColorTable;
