...
namespace AudioExtensions
{
    public partial class AudioDeviceConfigure : Form
    {
        ...
        public void Init( string title, AudioExtensions.IAudioDriver dr )
        {
            ...
            bool border = ExtendedControls.ThemeableFormsInstance.Instance?.ApplyToForm(this, System.Drawing.SystemFonts.DefaultFont) ?? FormBorderStyle != FormBorderStyle.None;
