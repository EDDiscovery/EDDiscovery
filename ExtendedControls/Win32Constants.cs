...
namespace ExtendedControls
{
    internal static class Win32Constants
    {
        ...
        #endregion // Menu Flag (MF)

        #region Tab Control Message (TCM)
        ...
        #endregion // Tab Control Message (TCM)
