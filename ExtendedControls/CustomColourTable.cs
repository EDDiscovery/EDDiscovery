...
namespace ExtendedControls
{
    public class CustomColourTable : ProfessionalColorTable
    {
        ...
        public Color colMenuBackground { get; set; } = Color.FromArgb(255, 188, 199, 216);//ControlPaint.LightLight(ControlPaint.Light(Color.SlateBlue));
        public Color colToolStripBorder { get; set; } = Color.FromArgb(255, 133, 145, 162); //0x8591A2);//ControlPaint.LightLight(Color.SlateBlue);
        public Color colToolStripBackGround { get; set; } = Color.LightGray;
        public Color colToolStripSeparator { get; set; } = Color.FromArgb(255, 133, 145, 162); //0x8591A2);//ControlPaint.LightLight(Color.SlateBlue);
        public Color colMenuSelectedBack { get; set; } = Color.FromArgb(255, 201, 210, 225); //ControlPaint.LightLight(ControlPaint.LightLight(Color.LightSlateGray));
        public Color colMenuSelectedText { get; set; } = Color.Black;
        public Color dark { get; set; } = Color.FromArgb(255, 41, 57, 85);
        public Color colMenuText { get; set; } = Color.White;
        public Color colButtonSelectedBorder { get; set; } = Color.FromArgb(229, 195, 101);
        public Color colButtonSelectBackLight { get; set; } = Color.FromArgb(255, 252, 242);
        public Color colButtonSelectBackDark { get; set; } = Color.FromArgb(255, 236, 181);
