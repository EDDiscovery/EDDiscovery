...
{
    public class PanelVScroll : Panel               // Written because I could not get the manual autoscroll to work when controls dynamically added
    {
        ...
        {  // as controls are added, remember them in local variables.
            ...
            if (e.Control != null && (e.Control is VScrollBarCustom || e.Control.GetType().IsSubclassOf(typeof(VScrollBarCustom))))
            {
