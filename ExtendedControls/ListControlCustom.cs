...
namespace ExtendedControls
{
    public class ListControlCustom : Control
    {
        ...
        public void SetFlatStyle(FlatStyle v)
        {
            ...
            Invalidate();
            lbsys.Items.AddRange(Items.ToArray());
        }
        ...
        private ListBox lbsys;                          // ✓ (this.Controls)
        private VScrollBarCustom vScrollBar;            // ✓ (this.Controls)
        ...
        protected override void OnLayout(LayoutEventArgs levent)
        {
            ...
            if (lbsys != null && flatstyle == FlatStyle.System && Width > 0)
            {
                lbsys.Width = Width;
                lbsys.Height = Height;
            }
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (!SelectionBackColor.IsFullyTransparent())
            {
            ...
            if (Items != null && Items.Count > 0)
            {
                ...
                Brush textb = new SolidBrush(ForeColor);
                ...
                {   // if not fitting to items height, 
                    if (offset >= firstindex && offset < firstindex + displayableitems + (FitToItemsHeight ? 0 : 1))
                    {
                        ...
                        e.Graphics.DrawString(s, Font, textb, pos, f);
        ...
        {
            if (SelectedIndex != lbsys.SelectedIndex)
            {
