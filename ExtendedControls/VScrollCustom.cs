...
namespace ExtendedControls
{
    public class VScrollBarCustom : Control
    {
        ...
        public VScrollBarCustom()
        {
            SetStyle(ControlStyles.OptimizedDoubleBuffer, true);
            repeatclick = new Timer();
            repeatclick.Tick += Repeatclick_Tick;
        }
        ...
        private enum MouseOver { MouseOverNone, MouseOverUp, MouseOverDown, MouseOverThumb };
        ...
        #region OnEvent overrides and dispatchers
        ...
        #endregion // OnEvent overrides and dispatchers
