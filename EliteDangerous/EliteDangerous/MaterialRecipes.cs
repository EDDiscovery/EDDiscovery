...
#region AUTOMATICALLY PRODUCED DATA
        ...
        new EngineeringRecipe("Light Weight Scanner", "1P", "Sensor", "1", "Bill Turner,Juri Ishmaak,Lei Cheung,Lori Jameson,Tiana Fortune" ),
        new EngineeringRecipe("Light Weight Scanner", "1SAll,1Mn", "Sensor", "2", "Bill Turner,Juri Ishmaak,Lei Cheung,Lori Jameson,Tiana Fortune" ),
        new EngineeringRecipe("Light Weight Scanner", "1SAll,1Mn,1CCe", "Sensor", "3", "Bill Turner,Juri Ishmaak,Lei Cheung,Lori Jameson,Tiana Fortune" ),
        new EngineeringRecipe("Light Weight Scanner", "1CCo,1PA,1PLA", "Sensor", "4", "Bill Turner,Juri Ishmaak,Lei Cheung,Lori Jameson,Tiana Fortune" ),
        new EngineeringRecipe("Light Weight Scanner", "1CCe,1PLA,1PRA", "Sensor", "5", "Bill Turner,Juri Ishmaak,Lei Cheung,Lori Jameson,Tiana Fortune" ),
        new EngineeringRecipe("Long-Range Scanner", "1Fe", "Sensor", "1", "Bill Turner,Felicity Farseer,Juri Ishmaak,Lei Cheung,Lori Jameson,Tiana Fortune" ),
        new EngineeringRecipe("Long-Range Scanner", "1Fe,1HC", "Sensor", "2", "Bill Turner,Felicity Farseer,Juri Ishmaak,Lei Cheung,Lori Jameson,Tiana Fortune" ),
        new EngineeringRecipe("Long-Range Scanner", "1Fe,1HC,1UED", "Sensor", "3", "Bill Turner,Felicity Farseer,Juri Ishmaak,Lei Cheung,Lori Jameson,Tiana Fortune" ),
        new EngineeringRecipe("Long-Range Scanner", "1Ge,1EA,1DED", "Sensor", "4", "Bill Turner,Juri Ishmaak,Lei Cheung,Lori Jameson,Tiana Fortune" ),
        new EngineeringRecipe("Long-Range Scanner", "1Nb,1PCa,1CED", "Sensor", "5", "Bill Turner,Lei Cheung,Lori Jameson,Tiana Fortune" ),
        new EngineeringRecipe("Wide Angle Scanner", "1MS", "Sensor", "1", "Bill Turner,Felicity Farseer,Juri Ishmaak,Lei Cheung,Lori Jameson,Tiana Fortune" ),
        new EngineeringRecipe("Wide Angle Scanner", "1MS,1Ge", "Sensor", "2", "Bill Turner,Felicity Farseer,Juri Ishmaak,Lei Cheung,Lori Jameson,Tiana Fortune" ),
        new EngineeringRecipe("Wide Angle Scanner", "1MS,1Ge,1CSD", "Sensor", "3", "Bill Turner,Felicity Farseer,Juri Ishmaak,Lei Cheung,Lori Jameson,Tiana Fortune" ),
        new EngineeringRecipe("Wide Angle Scanner", "1ME,1Nb,1DSD", "Sensor", "4", "Bill Turner,Juri Ishmaak,Lei Cheung,Lori Jameson,Tiana Fortune" ),
        new EngineeringRecipe("Wide Angle Scanner", "1MC,1Sn,1CFSD", "Sensor", "5", "Bill Turner,Lei Cheung,Lori Jameson,Tiana Fortune" ),
        ...
        new EngineeringRecipe("Fast Scanner", "1P", "Surface Scanner", "1", "Bill Turner,Felicity Farseer,Juri Ishmaak,Lei Cheung,Lori Jameson,Tiana Fortune" ),
        new EngineeringRecipe("Fast Scanner", "1P,1FFC", "Surface Scanner", "2", "Bill Turner,Felicity Farseer,Juri Ishmaak,Lei Cheung,Lori Jameson,Tiana Fortune" ),
        new EngineeringRecipe("Fast Scanner", "1P,1FFC,1OSK", "Surface Scanner", "3", "Bill Turner,Felicity Farseer,Juri Ishmaak,Lei Cheung,Lori Jameson,Tiana Fortune" ),
        new EngineeringRecipe("Fast Scanner", "1Mn,1FoC,1AEA", "Surface Scanner", "4", "Bill Turner,Juri Ishmaak,Lei Cheung,Lori Jameson" ),
        new EngineeringRecipe("Fast Scanner", "1As,1RFC,1AEC", "Surface Scanner", "5", "Bill Turner,Juri Ishmaak,Lei Cheung,Lori Jameson" ),
        new EngineeringRecipe("Long-Range Scanner", "1Fe", "Surface Scanner", "1", "Bill Turner,Felicity Farseer,Juri Ishmaak,Lei Cheung,Lori Jameson,Tiana Fortune" ),
        new EngineeringRecipe("Long-Range Scanner", "1Fe,1HC", "Surface Scanner", "2", "Bill Turner,Felicity Farseer,Juri Ishmaak,Lei Cheung,Lori Jameson,Tiana Fortune" ),
        new EngineeringRecipe("Long-Range Scanner", "1Fe,1HC,1UED", "Surface Scanner", "3", "Bill Turner,Felicity Farseer,Juri Ishmaak,Lei Cheung,Lori Jameson,Tiana Fortune" ),
        new EngineeringRecipe("Long-Range Scanner", "1Ge,1EA,1DED", "Surface Scanner", "4", "Bill Turner,Juri Ishmaak,Lei Cheung,Lori Jameson" ),
        new EngineeringRecipe("Long-Range Scanner", "1Nb,1PCa,1CED", "Surface Scanner", "5", "Bill Turner,Juri Ishmaak,Lei Cheung,Lori Jameson" ),
        new EngineeringRecipe("Wide Angle Scanner", "1MS", "Surface Scanner", "1", "Bill Turner,Felicity Farseer,Juri Ishmaak,Lei Cheung,Lori Jameson,Tiana Fortune" ),
        new EngineeringRecipe("Wide Angle Scanner", "1MS,1Ge", "Surface Scanner", "2", "Bill Turner,Felicity Farseer,Juri Ishmaak,Lei Cheung,Lori Jameson,Tiana Fortune" ),
        new EngineeringRecipe("Wide Angle Scanner", "1MS,1Ge,1CSD", "Surface Scanner", "3", "Bill Turner,Felicity Farseer,Juri Ishmaak,Lei Cheung,Lori Jameson,Tiana Fortune" ),
        new EngineeringRecipe("Wide Angle Scanner", "1ME,1Nb,1DSD", "Surface Scanner", "4", "Bill Turner,Juri Ishmaak,Lei Cheung,Lori Jameson" ),
        new EngineeringRecipe("Wide Angle Scanner", "1MC,1Sn,1CFSD", "Surface Scanner", "5", "Bill Turner,Juri Ishmaak,Lei Cheung,Lori Jameson" ),
