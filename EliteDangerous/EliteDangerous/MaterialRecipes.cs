...
namespace EliteDangerousCore
{
    public static class Recipes
    {
        ...
        public static List<TechBrokerUnlockRecipe> TechBrokerUnlocks = new List<TechBrokerUnlockRecipe>()
        {
            ...
            new TechBrokerUnlockRecipe("Flechette launcher Fixed Medium","30Fe,24Mo,22Re,26Ge,8CMMC"),
            new TechBrokerUnlockRecipe("Flechette launcher Turret Medium","28Fe,28Mo,20Re,24Ge,10AM"),
            new TechBrokerUnlockRecipe("Plasma shock cannon Fixed Medium","24V,26W,20Re,28Tc,6IOD"),
            new TechBrokerUnlockRecipe("Plasmashock cannon Gimbal Medium","24V,22W,20Re,28Tc,10PC"),
            new TechBrokerUnlockRecipe("Plasma shock cannon Turret Medium","24V,22W,20Re,28Tc,8PTB"),
            new TechBrokerUnlockRecipe("Corrosion proof cargo rack Size 4 Class 1","16MA,26Fe,18CM,22RB,12NFI"),
            new TechBrokerUnlockRecipe("Metaalloy hull reinforcement Size 1 Class 1","16MA,15FoC,22ASPA,20CCom,12RMP"),
            new TechBrokerUnlockRecipe("Guardian power plant Size 2","1GMBS,18GPC,21PEOD,15HRC,10EGA"),
            new TechBrokerUnlockRecipe("Guardian Gauss cannon Fixed Medium","1GWBS,18GPCe,20GTC,15Mn,6MEC"),
            new TechBrokerUnlockRecipe("Guardian Plasma launcher Fixed Medium","1GWBS,18GPC,16GSWP,14Cr,8MWCH"),
            new TechBrokerUnlockRecipe("Guardian Plasma launcher Turret Medium","2GWBS,21GPC,20GSWP,16Cr,8AM"),
            new TechBrokerUnlockRecipe("Guardian Shard cannon Fixed Medium","1GWBS,20GSWC,18GTC,14C,12PTB"),
            new TechBrokerUnlockRecipe("Guardian Shard cannon Turret Medium","2GWBS,16GSWC,20GTC,15C,12MCC"),
            new TechBrokerUnlockRecipe("Guardian power distributor Size 1","1GMBS,20PAOD,24GPCe,18PA,6HSI"),
            new TechBrokerUnlockRecipe("Guardian Shield Reinforcement Size 1 Class 1","1GMBS,17GPCe,20GTC,24PDOD,8DIS"),
            new TechBrokerUnlockRecipe("Guardian Hull Reinforcement Size 1 Class 1","1GMBS,21GSWC,16PBOD,16PGOD,12RMP"),
            new TechBrokerUnlockRecipe("Guardian Module Reinforcement Size 1 Class 1","1GMBS,18GSWC,15PEOD,20GPC,9RMP"),
            new TechBrokerUnlockRecipe("Guardian fsd booster Size 1","1GMBS,21GPCe,21GTC,24FoC,8HNSM"),
            new TechBrokerUnlockRecipe("Plasma shock cannon Fixed Large","28V,26W,24Re,26Tc,8PC"),
            new TechBrokerUnlockRecipe("Plasma shock cannon Gimbal Large","28V,24W,24Re,22Tc,12PTB"),
            new TechBrokerUnlockRecipe("Plasma shock cannon Turret Large","26V,28W,22Re,24Tc,10IOD"),
            new TechBrokerUnlockRecipe("Guardian Shard cannon Fixed Large","1GWBS,20GSWC,28GTC,20C,18MCC"),
            new TechBrokerUnlockRecipe("Guardian Shard cannon Turret Large","2GWBS,20GSWC,26GTC,28C,12MCC"),
            new TechBrokerUnlockRecipe("Guardian Plasma launcher Fixed Large","1GWBS,28GPC,20GSWP,28Cr,10MWCH"),
            new TechBrokerUnlockRecipe("Guardian Plasma launcher Turret Large","2GWBS,20GPC,24GSWP,26Cr,10AM"),
        };
