        ...
        public class Recipe
        {
            ...
            public Recipe(string n, string indg)
            {
                ...
                for (int i = 0; i < ilist.Length; i++)
                {
                    ...
                    count[i] = int.Parse(s);
                    ingredientsstringlong = ingredientsstringlong.AppendPrePad(count[i].ToStringInvariant() + " x " + MaterialCommodityData.GetCachedMaterialByShortName(ingredients[i]).name, Environment.NewLine);
                }
            }
        }
...
#region AUTOMATICALLY PRODUCED DATA
            // DATA FROM Frontiers excel spreadsheet with corolis modules.json to give engineers names
        ...
        new EngineeringRecipe("Shielded", "1C,1SE", "AFM", "2", "Bill Turner,Lori Jameson" ),
        new EngineeringRecipe("Shielded", "1C,1SE,1HDC", "AFM", "3", "Bill Turner,Lori Jameson" ),
        ...
        new EngineeringRecipe("Heavy Duty Armour", "1C,1SE", "Armour", "2", "Selene Jean" ),
        new EngineeringRecipe("Heavy Duty Armour", "1C,1SE,1HDC", "Armour", "3", "Selene Jean" ),
        ...
        new EngineeringRecipe("Efficient Weapon", "1IED,1Se,1HV", "Burst Laser", "4", "Broo Tarquin,The Dweller" ),
        ...
        new EngineeringRecipe("Focused Weapon", "1Ge,1FoC,1PCa", "Burst Laser", "4", "Broo Tarquin,The Dweller" ),
        ...
        new EngineeringRecipe("Light Weight Mount", "1CCo,1PA,1PLA", "Burst Laser", "4", "Broo Tarquin,The Dweller" ),
        ...
        new EngineeringRecipe("Long-Range Weapon", "1MCF,1FoC,1CPo", "Burst Laser", "4", "Broo Tarquin,The Dweller" ),
        ...
        new EngineeringRecipe("Overcharged Weapon", "1Zn,1CCe,1PCa", "Burst Laser", "4", "Broo Tarquin,The Dweller" ),
        ...
        new EngineeringRecipe("Rapid Fire Modification", "1MCF,1MC,1ThA", "Burst Laser", "4", "Broo Tarquin,The Dweller" ),
        ...
        new EngineeringRecipe("Short-Range Blaster", "1MCF,1EA,1CPo", "Burst Laser", "4", "Broo Tarquin,The Dweller" ),
        ...
        new EngineeringRecipe("Sturdy Mount", "1Zn,1W,1Mo", "Burst Laser", "4", "Broo Tarquin,The Dweller" ),
        ...
        new EngineeringRecipe("Rapid Fire Modification", "1MS", "Cannon", "1", "The Sarge,Tod McQuinn" ),
        new EngineeringRecipe("Rapid Fire Modification", "1MS,1HDP", "Cannon", "2", "The Sarge,Tod McQuinn" ),
        new EngineeringRecipe("Rapid Fire Modification", "1SLF,1ME,1PAll", "Cannon", "3", "The Sarge" ),
        new EngineeringRecipe("Rapid Fire Modification", "1MCF,1MC,1ThA", "Cannon", "4", "The Sarge" ),
        new EngineeringRecipe("Rapid Fire Modification", "1PAll,1CCom,1Tc", "Cannon", "5", "The Sarge" ),
        ...
        new EngineeringRecipe("Sturdy Mount", "1Ni,1SE", "Cannon", "2", "The Sarge,Tod McQuinn" ),
        ...
        new EngineeringRecipe("Lightweight", "1P", "Cargo Scanner", "1", "Bill Turner,Lori Jameson,Tiana Fortune" ),
        new EngineeringRecipe("Lightweight", "1SAll,1Mn", "Cargo Scanner", "2", "Bill Turner,Lori Jameson,Tiana Fortune" ),
        new EngineeringRecipe("Lightweight", "1SAll,1Mn,1CCe", "Cargo Scanner", "3", "Bill Turner,Lori Jameson,Tiana Fortune" ),
        ...
        new EngineeringRecipe("Reinforced", "1Ni", "Cargo Scanner", "1", "Bill Turner,Lori Jameson,Tiana Fortune" ),
        new EngineeringRecipe("Reinforced", "1Ni,1SE", "Cargo Scanner", "2", "Bill Turner,Lori Jameson,Tiana Fortune" ),
        new EngineeringRecipe("Reinforced", "1Ni,1SE,1W", "Cargo Scanner", "3", "Bill Turner,Lori Jameson,Tiana Fortune" ),
        ...
        new EngineeringRecipe("Shielded", "1WSE", "Cargo Scanner", "1", "Bill Turner,Lori Jameson,Tiana Fortune" ),
        new EngineeringRecipe("Shielded", "1C,1SE", "Cargo Scanner", "2", "Bill Turner,Lori Jameson,Tiana Fortune" ),
        new EngineeringRecipe("Shielded", "1C,1SE,1HDC", "Cargo Scanner", "3", "Bill Turner,Lori Jameson,Tiana Fortune" ),
        ...
        new EngineeringRecipe("Chaff Ammo Capacity", "1MS", "Chaff Launcher", "3", "Ram Tah" ),
        ...
        new EngineeringRecipe("Shielded", "1C,1SE,1HDC", "Chaff Launcher", "3", "Ram Tah" ),
        ...
        new EngineeringRecipe("Reinforced", "1Ni,1SE", "Collection Limpet", "2", "Ram Tah,The Sarge,Tiana Fortune" ),
        new EngineeringRecipe("Reinforced", "1Ni,1SE,1W", "Collection Limpet", "3", "Ram Tah,The Sarge,Tiana Fortune" ),
        ...
        new EngineeringRecipe("Shielded", "1C,1SE", "Collection Limpet", "2", "Ram Tah,The Sarge,Tiana Fortune" ),
        new EngineeringRecipe("Shielded", "1C,1SE,1HDC", "Collection Limpet", "3", "Ram Tah,The Sarge,Tiana Fortune" ),
        ...
        new EngineeringRecipe("Reinforced", "1Ni,1SE", "ECM", "2", "Ram Tah" ),
        new EngineeringRecipe("Reinforced", "1Ni,1SE,1W", "ECM", "3", "Ram Tah" ),
        ...
        new EngineeringRecipe("Shielded", "1C,1SE", "ECM", "2", "Ram Tah" ),
        new EngineeringRecipe("Shielded", "1C,1SE,1HDC", "ECM", "3", "Ram Tah" ),
        ...
        new EngineeringRecipe("Sturdy Mount", "1Ni,1SE", "Frag Cannon", "2", "Tod McQuinn,Zacariah Nemo" ),
        new EngineeringRecipe("Sturdy Mount", "1Ni,1SE,1W", "Frag Cannon", "3", "Tod McQuinn,Zacariah Nemo" ),
        ...
        new EngineeringRecipe("Increased FSD Range", "1Mn,1CD,1EHT", "FSD", "4", "Elvira Martuuk,Felicity Farseer" ),
        ...
        new EngineeringRecipe("Shielded FSD", "1C,1SE", "FSD", "2", "Colonel Bris Dekker,Elvira Martuuk,Felicity Farseer,Professor Palin" ),
        ...
        new EngineeringRecipe("Shielded", "1C,1SE", "Fuel Scoop", "2", "Bill Turner,Lori Jameson" ),
        new EngineeringRecipe("Shielded", "1C,1SE,1HDC", "Fuel Scoop", "3", "Bill Turner,Lori Jameson" ),
        ...
        new EngineeringRecipe("Reinforced", "1Ni,1SE", "Fuel Transfer Limpet", "2", "Ram Tah,The Sarge,Tiana Fortune" ),
        new EngineeringRecipe("Reinforced", "1Ni,1SE,1W", "Fuel Transfer Limpet", "3", "Ram Tah,The Sarge,Tiana Fortune" ),
        ...
        new EngineeringRecipe("Shielded", "1C,1SE", "Fuel Transfer Limpet", "2", "Ram Tah,The Sarge,Tiana Fortune" ),
        new EngineeringRecipe("Shielded", "1C,1SE,1HDC", "Fuel Transfer Limpet", "3", "Ram Tah,The Sarge,Tiana Fortune" ),
        ...
        new EngineeringRecipe("Lightweight", "1CCo,1PA,1PLA", "Hatch Breaker Limpet", "4", "Ram Tah,The Sarge,Tiana Fortune" ),
        ...
        new EngineeringRecipe("Reinforced", "1Ni,1SE", "Hatch Breaker Limpet", "2", "Ram Tah,The Sarge,Tiana Fortune" ),
        new EngineeringRecipe("Reinforced", "1Ni,1SE,1W", "Hatch Breaker Limpet", "3", "Ram Tah,The Sarge,Tiana Fortune" ),
        new EngineeringRecipe("Reinforced", "1Zn,1W,1Mo", "Hatch Breaker Limpet", "4", "Ram Tah,The Sarge,Tiana Fortune" ),
        ...
        new EngineeringRecipe("Shielded", "1C,1SE", "Hatch Breaker Limpet", "2", "Ram Tah,The Sarge,Tiana Fortune" ),
        new EngineeringRecipe("Shielded", "1C,1SE,1HDC", "Hatch Breaker Limpet", "3", "Ram Tah,The Sarge,Tiana Fortune" ),
        new EngineeringRecipe("Shielded", "1V,1SS,1FPC", "Hatch Breaker Limpet", "4", "Ram Tah,The Sarge,Tiana Fortune" ),
        new EngineeringRecipe("Shielded", "1W,1CoS,1FCC", "Hatch Breaker Limpet", "5", "The Sarge,Tiana Fortune" ),
        new EngineeringRecipe("Heatsink Ammo Capacity", "1MS,1V,1Nb", "Heat Sink Launcher", "3", "Ram Tah" ),
        ...
        new EngineeringRecipe("Shielded", "1C,1SE,1HDC", "Heat Sink Launcher", "3", "Ram Tah" ),
        ...
        new EngineeringRecipe("Heavy Duty Hull Reinforcement", "1C,1SE", "Hull Reinforcement", "2", "Selene Jean" ),
        new EngineeringRecipe("Heavy Duty Hull Reinforcement", "1C,1SE,1HDC", "Hull Reinforcement", "3", "Selene Jean" ),
        ...
        new EngineeringRecipe("Reinforced", "1Ni,1SE", "Kill Warrant Scanner", "2", "Bill Turner,Lori Jameson,Tiana Fortune" ),
        new EngineeringRecipe("Reinforced", "1Ni,1SE,1W", "Kill Warrant Scanner", "3", "Bill Turner,Lori Jameson,Tiana Fortune" ),
        ...
        new EngineeringRecipe("Shielded", "1C,1SE", "Kill Warrant Scanner", "2", "Bill Turner,Lori Jameson,Tiana Fortune" ),
        new EngineeringRecipe("Shielded", "1C,1SE,1HDC", "Kill Warrant Scanner", "3", "Bill Turner,Lori Jameson,Tiana Fortune" ),
        ...
        new EngineeringRecipe("Reinforced", "1Ni,1SE", "Life Support", "2", "Bill Turner,Lori Jameson" ),
        new EngineeringRecipe("Reinforced", "1Ni,1SE,1W", "Life Support", "3", "Bill Turner,Lori Jameson" ),
        ...
        new EngineeringRecipe("Shielded", "1C,1SE", "Life Support", "2", "Bill Turner,Lori Jameson" ),
        new EngineeringRecipe("Shielded", "1C,1SE,1HDC", "Life Support", "3", "Bill Turner,Lori Jameson" ),
        ...
        new EngineeringRecipe("Sturdy Mount", "1Ni,1SE", "Mine", "2", "Juri Ishmaak,Liz Ryder" ),
        new EngineeringRecipe("Sturdy Mount", "1Ni,1SE,1W", "Mine", "3", "Juri Ishmaak,Liz Ryder" ),
        ...
        new EngineeringRecipe("Sturdy Mount", "1Ni,1SE", "Missile", "2", "Juri Ishmaak,Liz Ryder" ),
        new EngineeringRecipe("Sturdy Mount", "1Ni,1SE,1W", "Missile", "3", "Juri Ishmaak,Liz Ryder" ),
        ...
        new EngineeringRecipe("Sturdy Mount", "1Ni,1SE", "Multicannon", "2", "Tod McQuinn,Zacariah Nemo" ),
        new EngineeringRecipe("Sturdy Mount", "1Ni,1SE,1W", "Multicannon", "3", "Tod McQuinn,Zacariah Nemo" ),
        ...
        new EngineeringRecipe("Sturdy Mount", "1Ni,1SE", "Plasma Accelerator", "2", "Bill Turner,Zacariah Nemo" ),
        ...
        new EngineeringRecipe("Point Defence Ammo Capacity", "1MS,1V,1Nb", "Point Defence", "3", "Ram Tah" ),
        ...
        new EngineeringRecipe("Shielded", "1C,1SE,1HDC", "Point Defence", "3", "Ram Tah" ),
        ...
        new EngineeringRecipe("Charge Enhanced Power Distributor", "1GR,1MCF,1CD", "Power Distributor", "3", "Hera Tani,Marco Qwent,The Dweller" ),
        ...
        new EngineeringRecipe("Shielded Power Distributor", "1C,1SE", "Power Distributor", "2", "Hera Tani,Marco Qwent,The Dweller" ),
        new EngineeringRecipe("Shielded Power Distributor", "1C,1SE,1HDC", "Power Distributor", "3", "Hera Tani,Marco Qwent,The Dweller" ),
        ...
        new EngineeringRecipe("Armoured Power Plant", "1C,1SE", "Power Plant", "2", "Hera Tani,Marco Qwent" ),
        new EngineeringRecipe("Armoured Power Plant", "1C,1SE,1HDC", "Power Plant", "3", "Hera Tani,Marco Qwent" ),
        ...
        new EngineeringRecipe("Reinforced", "1Ni,1SE", "Prospecting Limpet", "2", "Ram Tah,The Sarge,Tiana Fortune" ),
        new EngineeringRecipe("Reinforced", "1Ni,1SE,1W", "Prospecting Limpet", "3", "Ram Tah,The Sarge,Tiana Fortune" ),
        ...
        new EngineeringRecipe("Shielded", "1C,1SE", "Prospecting Limpet", "2", "Ram Tah,The Sarge,Tiana Fortune" ),
        new EngineeringRecipe("Shielded", "1C,1SE,1HDC", "Prospecting Limpet", "3", "Ram Tah,The Sarge,Tiana Fortune" ),
        ...
        new EngineeringRecipe("Sturdy Mount", "1Ni,1SE", "Rail Gun", "2", "The Sarge,Tod McQuinn" ),
        new EngineeringRecipe("Sturdy Mount", "1Ni,1SE,1W", "Rail Gun", "3", "The Sarge,Tod McQuinn" ),
        ...
        new EngineeringRecipe("Shielded", "1C,1SE", "Refineries", "2", "Bill Turner,Lori Jameson" ),
        new EngineeringRecipe("Shielded", "1C,1SE,1HDC", "Refineries", "3", "Bill Turner,Lori Jameson" ),
        new EngineeringRecipe("Shielded", "1V,1SS,1FPC", "Refineries", "4", "Lori Jameson" ),
        new EngineeringRecipe("Light Weight Scanner", "1P", "Sensor", "1", "Bill Turner,Juri Ishmaak,Lei Chung,Lori Jameson,Tiana Fortune" ),
        new EngineeringRecipe("Light Weight Scanner", "1SAll,1Mn", "Sensor", "2", "Bill Turner,Juri Ishmaak,Lei Chung,Lori Jameson,Tiana Fortune" ),
        new EngineeringRecipe("Light Weight Scanner", "1SAll,1Mn,1CCe", "Sensor", "3", "Bill Turner,Juri Ishmaak,Lei Chung,Lori Jameson,Tiana Fortune" ),
        new EngineeringRecipe("Light Weight Scanner", "1CCo,1PA,1PLA", "Sensor", "4", "Bill Turner,Juri Ishmaak,Lei Chung,Lori Jameson,Tiana Fortune" ),
        new EngineeringRecipe("Light Weight Scanner", "1CCe,1PLA,1PRA", "Sensor", "5", "Bill Turner,Juri Ishmaak,Lei Chung,Lori Jameson,Tiana Fortune" ),
        new EngineeringRecipe("Long-Range Scanner", "1Fe", "Sensor", "1", "Bill Turner,Felicity Farseer,Juri Ishmaak,Lei Chung,Lori Jameson,Tiana Fortune" ),
        new EngineeringRecipe("Long-Range Scanner", "1Fe,1HC", "Sensor", "2", "Bill Turner,Felicity Farseer,Juri Ishmaak,Lei Chung,Lori Jameson,Tiana Fortune" ),
        new EngineeringRecipe("Long-Range Scanner", "1Fe,1HC,1UED", "Sensor", "3", "Bill Turner,Felicity Farseer,Juri Ishmaak,Lei Chung,Lori Jameson,Tiana Fortune" ),
        new EngineeringRecipe("Long-Range Scanner", "1Ge,1EA,1DED", "Sensor", "4", "Bill Turner,Juri Ishmaak,Lei Chung,Lori Jameson,Tiana Fortune" ),
        new EngineeringRecipe("Long-Range Scanner", "1Nb,1PCa,1CED", "Sensor", "5", "Bill Turner,Lei Chung,Lori Jameson,Tiana Fortune" ),
        new EngineeringRecipe("Wide Angle Scanner", "1MS", "Sensor", "1", "Bill Turner,Felicity Farseer,Juri Ishmaak,Lei Chung,Lori Jameson,Tiana Fortune" ),
        new EngineeringRecipe("Wide Angle Scanner", "1MS,1Ge", "Sensor", "2", "Bill Turner,Felicity Farseer,Juri Ishmaak,Lei Chung,Lori Jameson,Tiana Fortune" ),
        new EngineeringRecipe("Wide Angle Scanner", "1MS,1Ge,1CSD", "Sensor", "3", "Bill Turner,Felicity Farseer,Juri Ishmaak,Lei Chung,Lori Jameson,Tiana Fortune" ),
        new EngineeringRecipe("Wide Angle Scanner", "1ME,1Nb,1DSD", "Sensor", "4", "Bill Turner,Juri Ishmaak,Lei Chung,Lori Jameson,Tiana Fortune" ),
        new EngineeringRecipe("Wide Angle Scanner", "1MC,1Sn,1CFSD", "Sensor", "5", "Bill Turner,Lei Chung,Lori Jameson,Tiana Fortune" ),
        new EngineeringRecipe("Blast Resistant Shield Booster", "1Fe", "Shield Booster", "1", "Didi Vatermann,Felicity Farseer,Lei Chung" ),
        new EngineeringRecipe("Blast Resistant Shield Booster", "1Fe,1CCo", "Shield Booster", "2", "Didi Vatermann,Lei Chung" ),
        new EngineeringRecipe("Blast Resistant Shield Booster", "1Fe,1CCo,1FoC", "Shield Booster", "3", "Didi Vatermann,Lei Chung" ),
        ...
        new EngineeringRecipe("Heavy Duty Shield Booster", "1GR", "Shield Booster", "1", "Didi Vatermann,Felicity Farseer,Lei Chung" ),
        new EngineeringRecipe("Heavy Duty Shield Booster", "1DSCR,1HC", "Shield Booster", "2", "Didi Vatermann,Lei Chung" ),
        new EngineeringRecipe("Heavy Duty Shield Booster", "1DSCR,1HC,1Nb", "Shield Booster", "3", "Didi Vatermann,Lei Chung" ),
        ...
        new EngineeringRecipe("Kinetic Resistant Shield Booster", "1Fe", "Shield Booster", "1", "Didi Vatermann,Felicity Farseer,Lei Chung" ),
        new EngineeringRecipe("Kinetic Resistant Shield Booster", "1GR,1Ge", "Shield Booster", "2", "Didi Vatermann,Lei Chung" ),
        new EngineeringRecipe("Kinetic Resistant Shield Booster", "1SAll,1HC,1FoC", "Shield Booster", "3", "Didi Vatermann,Lei Chung" ),
        ...
        new EngineeringRecipe("Resistance Augmented Shield Booster", "1P", "Shield Booster", "1", "Didi Vatermann,Felicity Farseer,Lei Chung" ),
        new EngineeringRecipe("Resistance Augmented Shield Booster", "1P,1CCo", "Shield Booster", "2", "Didi Vatermann,Lei Chung" ),
        new EngineeringRecipe("Resistance Augmented Shield Booster", "1P,1CCo,1FoC", "Shield Booster", "3", "Didi Vatermann,Lei Chung" ),
        ...
        new EngineeringRecipe("Thermal Resistant Shield Booster", "1Fe", "Shield Booster", "1", "Didi Vatermann,Felicity Farseer,Lei Chung" ),
        new EngineeringRecipe("Thermal Resistant Shield Booster", "1HCW,1Ge", "Shield Booster", "2", "Didi Vatermann,Lei Chung" ),
        new EngineeringRecipe("Thermal Resistant Shield Booster", "1HCW,1HDP,1FoC", "Shield Booster", "3", "Didi Vatermann,Lei Chung" ),
        ...
        new EngineeringRecipe("Fast Scanner", "1P", "Surface Scanner", "1", "Bill Turner,Felicity Farseer,Juri Ishmaak,Lei Chung,Lori Jameson,Tiana Fortune" ),
        new EngineeringRecipe("Fast Scanner", "1P,1FFC", "Surface Scanner", "2", "Bill Turner,Felicity Farseer,Juri Ishmaak,Lei Chung,Lori Jameson,Tiana Fortune" ),
        new EngineeringRecipe("Fast Scanner", "1P,1FFC,1OSK", "Surface Scanner", "3", "Bill Turner,Felicity Farseer,Juri Ishmaak,Lei Chung,Lori Jameson,Tiana Fortune" ),
        new EngineeringRecipe("Fast Scanner", "1Mn,1FoC,1AEA", "Surface Scanner", "4", "Bill Turner,Juri Ishmaak,Lei Chung,Lori Jameson" ),
        new EngineeringRecipe("Fast Scanner", "1As,1RFC,1AEC", "Surface Scanner", "5", "Bill Turner,Juri Ishmaak,Lei Chung,Lori Jameson" ),
        new EngineeringRecipe("Long-Range Scanner", "1Fe", "Surface Scanner", "1", "Bill Turner,Felicity Farseer,Juri Ishmaak,Lei Chung,Lori Jameson,Tiana Fortune" ),
        new EngineeringRecipe("Long-Range Scanner", "1Fe,1HC", "Surface Scanner", "2", "Bill Turner,Felicity Farseer,Juri Ishmaak,Lei Chung,Lori Jameson,Tiana Fortune" ),
        new EngineeringRecipe("Long-Range Scanner", "1Fe,1HC,1UED", "Surface Scanner", "3", "Bill Turner,Felicity Farseer,Juri Ishmaak,Lei Chung,Lori Jameson,Tiana Fortune" ),
        new EngineeringRecipe("Long-Range Scanner", "1Ge,1EA,1DED", "Surface Scanner", "4", "Bill Turner,Juri Ishmaak,Lei Chung,Lori Jameson" ),
        new EngineeringRecipe("Long-Range Scanner", "1Nb,1PCa,1CED", "Surface Scanner", "5", "Bill Turner,Juri Ishmaak,Lei Chung,Lori Jameson" ),
        new EngineeringRecipe("Wide Angle Scanner", "1MS", "Surface Scanner", "1", "Bill Turner,Felicity Farseer,Juri Ishmaak,Lei Chung,Lori Jameson,Tiana Fortune" ),
        new EngineeringRecipe("Wide Angle Scanner", "1MS,1Ge", "Surface Scanner", "2", "Bill Turner,Felicity Farseer,Juri Ishmaak,Lei Chung,Lori Jameson,Tiana Fortune" ),
        new EngineeringRecipe("Wide Angle Scanner", "1MS,1Ge,1CSD", "Surface Scanner", "3", "Bill Turner,Felicity Farseer,Juri Ishmaak,Lei Chung,Lori Jameson,Tiana Fortune" ),
        new EngineeringRecipe("Wide Angle Scanner", "1ME,1Nb,1DSD", "Surface Scanner", "4", "Bill Turner,Juri Ishmaak,Lei Chung,Lori Jameson" ),
        new EngineeringRecipe("Wide Angle Scanner", "1MC,1Sn,1CFSD", "Surface Scanner", "5", "Bill Turner,Juri Ishmaak,Lei Chung,Lori Jameson" ),
        ...
        new EngineeringRecipe("Sturdy Mount", "1Ni,1SE", "Torpedo", "2", "Juri Ishmaak,Liz Ryder" ),
        new EngineeringRecipe("Sturdy Mount", "1Ni,1SE,1W", "Torpedo", "3", "Juri Ishmaak,Liz Ryder" ),
        ...
        new EngineeringRecipe("Reinforced", "1Ni,1SE", "Wake Scanner", "2", "Bill Turner,Lori Jameson,Tiana Fortune" ),
        new EngineeringRecipe("Reinforced", "1Ni,1SE,1W", "Wake Scanner", "3", "Bill Turner,Lori Jameson,Tiana Fortune" ),
        ...
        new EngineeringRecipe("Shielded", "1C,1SE", "Wake Scanner", "2", "Bill Turner,Lori Jameson,Tiana Fortune" ),
        new EngineeringRecipe("Shielded", "1C,1SE,1HDC", "Wake Scanner", "3", "Bill Turner,Lori Jameson,Tiana Fortune" ),
