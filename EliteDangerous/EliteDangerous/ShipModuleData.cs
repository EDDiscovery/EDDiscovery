...
namespace EliteDangerousCore
{
    public class ShipModuleData
    {
        ...
        static Dictionary<string, ShipModule> noncorolismodules = new Dictionary<string, ShipModule>
        {
            ...
            { "hpt_shipdatalinkscanner", new ShipModule(-1,0, "Ship Data Link Scanner" , "Sensors" ) },

            // Robby Logs showed this
...
#region FROM COROLIS  NEVER EVER do this manually, its done using a corolis-data scanner in testnetlogentry!
        ...
        static Dictionary<string, ShipModule> modules = new Dictionary<string, ShipModule>
        {
...
///////////////////////////////////// FROM MODULE SCAN
            ...
            { "hpt_multicannon_fixed_small_scatter", new ShipModule(128671345, 2, 0.28F, "Ammo:1000/60, Damage:2.9, Range:4500m, Speed:1800m/s, Reload:4s, ThermL:0.2","Multi Cannon Fixed Small Scatter", "Multi Cannon")},
            ...
            { "hpt_pulselaser_fixed_medium_distruptor", new ShipModule(128671342, 4, 0.7F, "ROF:1.7/s, Damage:2.8, ThermL:1","Pulse Laser Fixed Medium Distruptor", "Pulse Laser")},
            ...
            { "int_dronecontrol_resourcesiphon_size7_class5", new ShipModule(128066551, 90, 0.98F, "Time:11s, Range:6km","Hatch Breaker Drone Controller Class 7 Rating A", "Limpet Controller")},
            ...
            { "int_hyperdrive_size8_class1", new ShipModule(128064133, 160, 0, "OptMass:0t","Hyperdrive Class 8 Rating E", "Hyperdrive")},
            { "int_hyperdrive_size8_class2", new ShipModule(128064134, 64, 0, "OptMass:0t","Hyperdrive Class 8 Rating D", "Hyperdrive")},
            { "int_hyperdrive_size8_class3", new ShipModule(128064135, 160, 0, "OptMass:0t","Hyperdrive Class 8 Rating C", "Hyperdrive")},
            { "int_hyperdrive_size8_class4", new ShipModule(128064136, 256, 0, "OptMass:0t","Hyperdrive Class 8 Rating B", "Hyperdrive")},
            { "int_hyperdrive_size8_class5", new ShipModule(128064137, 160, 0, "OptMass:0t","Hyperdrive Class 8 Rating A", "Hyperdrive")},
            ...
            { "type9_military_armour_grade1", new ShipModule(128049334,0,0,"Explosive:-40%, Kinetic:-20%, Thermal:0%","Type-10 Defender Lightweight Armour","Armour")},
            { "type9_military_armour_grade2", new ShipModule(128049335,75,0,"Explosive:-40%, Kinetic:-20%, Thermal:0%","Type-10 Defender Reinforced Armour","Armour")},
            { "type9_military_armour_grade3", new ShipModule(128049336,150,0,"Explosive:-40%, Kinetic:-20%, Thermal:0%","Type-10 Defender Military Armour","Armour")},
            { "type9_military_armour_mirrored", new ShipModule(128049337,150,0,"Explosive:-50%, Kinetic:-75%, Thermal:50%","Type-10 Defender Mirrored Surface Composite Armour","Armour")},
            { "type9_military_armour_reactive", new ShipModule(128049338,150,0,"Explosive:20%, Kinetic:25%, Thermal:-40%","Type-10 Defender Reactive Surface Composite Armour","Armour")},
            ...
            { "typex_armour_grade2", new ShipModule(128816577,75,0,"Explosive:-40%, Kinetic:-20%, Thermal:0%","Alliance Chieftain Reinforced Armour","Armour")},
            { "typex_armour_grade3", new ShipModule(128816578,150,0,"Explosive:-40%, Kinetic:-20%, Thermal:0%","Alliance Chieftain Military Armour","Armour")},
            { "typex_armour_mirrored", new ShipModule(128816579,150,0,"Explosive:-50%, Kinetic:-75%, Thermal:50%","Alliance Chieftain Mirrored Surface Composite Armour","Armour")},
            { "typex_armour_reactive", new ShipModule(128816580,150,0,"Explosive:20%, Kinetic:25%, Thermal:-40%","Alliance Chieftain Reactive Surface Composite Armour","Armour")},
        ...
        static Dictionary<string, Dictionary<ShipPropID, ShipInfo>> ships = new Dictionary<string, Dictionary<ShipPropID, ShipInfo>>
        {
            { "adder",adder},
            { "anaconda",anaconda},
            { "asp",asp},
