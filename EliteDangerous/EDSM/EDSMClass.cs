...
namespace EliteDangerousCore.EDSM
{
    public partial class EDSMClass : BaseUtils.HttpCom
    {
        ...
        public string RequestSystems(DateTime startdate, DateTime enddate, bool returnPartial = false)
        {
            ...
            var response = RequestGet(query, handleException: true, returnPartial: returnPartial);
            if (response.Error)
                return null;
