...
namespace EliteDangerousCore.JournalEvents
{
    ...
    public class JournalBounty : JournalEntry, ILedgerNoCashJournalEntry
    {
        ...
        public override System.Drawing.Bitmap Icon { get { return EliteDangerousCore.Properties.Resources.bounty; } }
        ...
        public override void FillInformation(out string summary, out string info, out string detailed) //V
        {
            ...
            info = BaseUtils.FieldBuilder.Build("; credits", TotalReward, "Target:", (string)Target, "Victim faction:", VictimFactionLocalised.Alt(VictimFaction));
            ...
            if ( Rewards!=null)
            {
                foreach (BountyReward r in Rewards)
                {
                    ...
                    detailed += BaseUtils.FieldBuilder.Build("Faction:", r.Faction, "; credits", r.Reward);
                }
            }
        }
    }
