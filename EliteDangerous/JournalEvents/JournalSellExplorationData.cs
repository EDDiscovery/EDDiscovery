...
namespace EliteDangerousCore.JournalEvents
{
    ...
    public class JournalSellExplorationData : JournalEntry, ILedgerJournalEntry
    {
        ...
        public override System.Drawing.Bitmap Icon { get { return EliteDangerousCore.Properties.Resources.sellexplorationdata; } }
        ...
        public override void FillInformation(out string summary, out string info, out string detailed) //V
        {
            ...
            info = BaseUtils.FieldBuilder.Build("Amount:; credits", BaseValue, "Bonus:; credits", Bonus);
            detailed = "";
            if (Systems != null)
            {
                detailed += "Scanned:";
